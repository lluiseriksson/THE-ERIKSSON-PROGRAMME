...
|---|---|---|
| `HasSpectralGap T P₀ γ C` | C106 / v1.34.0 | Replaced by `HasNormContraction` |
...
- C110 (v1.34.0): FeynmanKacBundle in YangMills/L8_Terminal/FeynmanKacBundle.lean -- bundles FeynmanKacFormula+StateNormBound+HasSpectralGap+distP_nonneg; physicalStrong_of_feynmanKacBundle; oracle clean.

- C111 (v1.34.0): ClayStrongFromFeynmanKac in YangMills/L8_Terminal/ClayStrongFromFeynmanKac.lean -- clayStrong_of_feynmanKacBundle : FeynmanKacBundle -> ClayYangMillsStrong; oracle clean.
