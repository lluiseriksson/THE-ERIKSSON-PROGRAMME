...
Publication-only update (2026-08-04): the 9-page paper *Endpoint Parity Loss in
a Bessel Wronskian* was submitted as a **new** ai.viXra companion paper, not as
a replacement for `ai.viXra:2607.0089`. Its exact PDF, metadata, clean replay,
...
It proves a no-go result for the kernel-and-anchor proof architecture, not the
global Wronskian conjecture. The public identifier remains pending; do not
resubmit.
