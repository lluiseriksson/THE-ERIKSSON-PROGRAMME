...
core green at **8400 jobs**, with Mathlib pinned and every headline oracle-clean
...
lake build YangMillsCore    # 8400 jobs at the latest recorded checkpoint; fast with warm cache
```
