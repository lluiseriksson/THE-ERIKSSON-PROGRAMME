...
core green at **8403 jobs**, with Mathlib pinned and every headline oracle-clean
...
lake build YangMillsCore    # 8403 jobs at the latest recorded checkpoint; fast with warm cache
```
