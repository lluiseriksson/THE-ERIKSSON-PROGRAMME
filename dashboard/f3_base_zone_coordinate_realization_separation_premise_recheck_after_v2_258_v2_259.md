# F3 base-zone coordinate realization/separation premise recheck after v2.258 / v2.259
...
| `PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateCodeInjection1296` | Upstream into origin-certificate source | Context only; v2.255 keeps this blocked upstream by bookkeeping tag-coordinate. |
| `PhysicalPlaquetteGraphResidualFiberBookkeepingBaseZoneTagCoordinate1296` | Upstream into origin-certificate code injection, not direct proof here | Context only; still blocked at selector-admissible coordinate injection/source chain. |
...
The known deeper blocker from the v2.254/v2.255 recheck remains
`PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateCodeInjection1296`,
