# F3 base-zone origin-certificate source premise recheck after v2.265 / v2.266
...
This bridge repacks selector-independent origin-certificate code-injection data
into the richer origin-certificate source interface. It does not construct the
...
| `PhysicalPlaquetteGraphResidualFiberBookkeepingBaseZoneTagCoordinate1296` | Upstream into code injection, not direct proof here | Context only; v2.261/v2.262 keeps this blocked upstream by selector-admissible coordinate injection. |
...
| `PhysicalPlaquetteGraphResidualFiberSelectorAdmissibleBaseZoneCoordinateInjection1296` as reverse evidence from downstream bookkeeping | Downstream/circular if obtained through this frontier | Rejected by task guardrail. |
...
The known deeper blocker from the v2.261/v2.262 recheck remains
