# F3 selector-admissible base-zone coordinate injection premise recheck after v2.262 / v2.263
...
This bridge erases selector-admissible coordinate source data into the
coordinate injection interface. It does not construct the selector-admissible
...
| `PhysicalPlaquetteGraphResidualFiberBaseZoneCoordinateRealizationSeparation1296` | Upstream into selector-admissible coordinate source | Context only; v2.259 keeps this blocked upstream by origin-certificate source. |
...
| `PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateCodeInjection1296` | Downstream through bookkeeping tag-coordinate/source interfaces | Rejected by task guardrail. |
| `PhysicalPlaquetteGraphResidualFiberBaseZoneCoordinateRealizationSeparation1296` as reverse evidence from coordinate source/injection | Downstream/circular if obtained through this frontier | Rejected by task guardrail. |
...
The known deeper blocker from the v2.258/v2.259 recheck remains
`PhysicalPlaquetteGraphResidualFiberBaseZoneCoordinateRealizationSeparation1296`,
...
`CODEX-F3-SELECTOR-ADMISSIBLE-BASE-ZONE-COORDINATE-SOURCE-PREMISE-RECHECK-AFTER-V2-263-001`
