# F3 selector-admissible base-zone coordinate source premise recheck after v2.263 / v2.264
...
| `PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateSource1296` | Upstream into base-zone coordinate realization/separation | Context only; v2.259/v2.260 keeps this blocked upstream by origin-certificate code injection. |
| `PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateCodeInjection1296` | Deeper upstream into origin-certificate source | Context only; not a direct proof of coordinate source. |
...
| `PhysicalPlaquetteGraphResidualFiberBaseZoneOriginCertificateSource1296` as reverse evidence from realization/separation | Downstream/circular if obtained through this frontier | Rejected by task guardrail. |
...
The known deeper blocker from the v2.259/v2.260 recheck remains
