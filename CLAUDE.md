...
7. **After adding a module to the core, confirm the build job count
   incremented** (latest recorded checkpoint: 8428, ledger Addendum 533).
...
* Latest recorded core checkpoint: **8428 jobs**, zero sorry, zero project axioms.
  ...
  source checkpoint is `ac897963` (on `main`).  See
  `REPRODUCIBILITY.md`.
