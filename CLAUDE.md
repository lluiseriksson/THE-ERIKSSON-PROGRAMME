...
7. **After adding a module to the core, confirm the build job count
   incremented** (latest recorded checkpoint: 8411, ledger Addendum 506).
...
* Latest recorded core checkpoint: **8411 jobs**, zero sorry, zero axioms.
  ...
  source checkpoint is `740ee636` (on `main`).  See
  `REPRODUCIBILITY.md`.
