#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for the C6d Green owner prefix."""
...
RUNNER_PATH = "scripts/colab_c6d_green_owner_prefix_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_green_owner_prefix_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_green_owner_prefix_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_GREEN_OWNER_PREFIX_NOTEBOOK_BASE_IMPORT_FAILED")
