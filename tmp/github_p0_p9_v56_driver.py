#!/usr/bin/env python3
"""Exact stop-on-first-error GitHub driver for the P0--P9 v56 scratch chain."""
...
def main() -> int:
    ...
    if args.contract_only:
        ...
        if len(stages) != 49 or sum(AXIOM_COUNTS.values()) != 199:
            raise SystemExit("P0_P9_V56_GITHUB_CONTRACT_DRIFT")
        print(
            "P0_P9_V56_GITHUB_CONTRACT_OK paths=39 stages=49 "
