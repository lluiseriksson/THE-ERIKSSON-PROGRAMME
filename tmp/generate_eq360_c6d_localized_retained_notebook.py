#!/usr/bin/env python3
"""Generate the one-cell launcher for the pinned source-facing Eq. (3.60)."""
...
RUNNER_PATH = "scripts/colab_eq360_c6d_localized_retained_validation.py"
OUTPUT = ROOT / "scripts" / "colab_eq360_c6d_localized_retained_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("eq360_c6d_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("EQ360_C6D_NOTEBOOK_BASE_IMPORT_FAILED")
