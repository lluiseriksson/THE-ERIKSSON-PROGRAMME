#!/usr/bin/env python3
"""Generate the retained one-cell launcher for the weighted/final C6d prefix."""
...
RUNNER_PATH = "scripts/colab_c6d_weighted_final_prefix_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_weighted_final_prefix_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location(
        "c6d_weighted_final_notebook_base", BASE
    )
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_WEIGHTED_FINAL_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "C6D_WEIGHTED_FINAL_NOTEBOOK_GENERATED "
