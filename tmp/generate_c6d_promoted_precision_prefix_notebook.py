#!/usr/bin/env python3
"""Generate the one-cell launcher for the promoted C6d precision prefix."""
...
RUNNER_PATH = "scripts/colab_c6d_promoted_precision_prefix_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_promoted_precision_prefix_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_promoted_prefix_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_PROMOTED_PREFIX_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "C6D_PROMOTED_PREFIX_NOTEBOOK_GENERATED "
