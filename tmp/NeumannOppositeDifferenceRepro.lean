...
not verified. Scalar plane-wave algebra only. It does not identify a finite
...
#print axioms YangMills.RG.neumannOppositeExponentialDifference
#print axioms YangMills.RG.neumannIntegerPlaneWave_centeredDifference
