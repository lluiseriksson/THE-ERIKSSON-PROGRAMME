#!/usr/bin/env python3
"""Fail-closed verifier for the repaired directed CMP89 endpoint evidence."""
...
EXPECTED_RUNNER = "cmp89-eq246-directed-endpoint-envelope-diagnostic-v2"
EXPECTED_SOURCE = "ef8bf1eab26821c0575cb00701ec0ce804628d4e"
...
def main() -> None:
    ...
    print("CMP89_EQ246_DIRECTED_ENDPOINT_ENVELOPE_RETRY_EVIDENCE_OK")
