#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for the post-Green decay prefix."""
...
RUNNER_PATH = "scripts/colab_c6d_post_green_decay_prefix_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_post_green_decay_prefix_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_post_green_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_POST_GREEN_NOTEBOOK_BASE_IMPORT_FAILED")
