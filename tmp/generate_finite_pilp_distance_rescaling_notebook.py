#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for kernel-distance rescaling."""
...
RUNNER_PATH = "scripts/colab_finite_pilp_distance_rescaling_validation.py"
OUTPUT = ROOT / "scripts" / "colab_finite_pilp_distance_rescaling_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("distance_rescaling_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("DISTANCE_RESCALING_NOTEBOOK_BASE_IMPORT_FAILED")
