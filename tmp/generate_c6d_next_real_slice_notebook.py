#!/usr/bin/env python3
"""Generate the one-cell launcher for a pinned next C6d real-slice gate."""
...
RUNNER_PATH = "scripts/colab_c6d_next_real_slice_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_next_real_slice_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("eq359_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_NEXT_REAL_SLICE_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "C6D_NEXT_REAL_SLICE_NOTEBOOK_GENERATED "
