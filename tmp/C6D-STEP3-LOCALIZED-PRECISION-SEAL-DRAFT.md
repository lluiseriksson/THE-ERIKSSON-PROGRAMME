# Draft only — C6d Step-3 localized physical precision seal
...
```text
Delta'_a = Delta_U + a_j Q'^* Q'
```

from the physical regularity witness and the internally generated localized
retained tower.  It exports the literal two-summand equality,
localized/canonical and exponential-source dictionaries, symmetry, and the
exact quadratic form.  No precision, `Qprime`, coercivity estimate, Green
...
### Step 8b.24/C6d.1: literal localized retained precision ([PASS-STATE]; 20/41 unchanged)

Copy the exact evidence paragraph above only after the post-verifier and
evidence hashes are complete.  This step supplies the regional operator
dictionary needed before transporting the fixed-depth CMP96 Green/action
certificates to the retained source tower.  It does not supply any subsequent
inverse or quantitative decay estimate.
