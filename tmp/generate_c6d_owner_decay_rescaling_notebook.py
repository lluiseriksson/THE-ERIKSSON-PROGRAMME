#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for C6d owner-distance rescaling."""
...
RUNNER_PATH = "scripts/colab_c6d_owner_decay_rescaling_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_owner_decay_rescaling_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_owner_rescaling_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_OWNER_RESCALING_NOTEBOOK_BASE_IMPORT_FAILED")
