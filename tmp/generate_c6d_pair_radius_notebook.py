#!/usr/bin/env python3
"""Generate the one-cell launcher for the pinned C6d pair/radius gate."""
...
RUNNER_PATH = "scripts/colab_c6d_pair_radius_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_pair_radius_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_pair_radius_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_PAIR_RADIUS_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "C6D_PAIR_RADIUS_NOTEBOOK_GENERATED "
