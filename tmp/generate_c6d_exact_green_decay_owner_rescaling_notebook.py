#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for the unified C6d D2 gate."""
...
RUNNER_PATH = "scripts/colab_c6d_exact_green_decay_owner_rescaling_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_exact_green_decay_owner_rescaling_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_d2_owner_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_D2_OWNER_NOTEBOOK_BASE_IMPORT_FAILED")
