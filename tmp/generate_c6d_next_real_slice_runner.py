#!/usr/bin/env python3
"""Generate the pinned cold Colab runner for the next C6d real-slice gate."""
...
OUTPUT = ROOT / "scripts" / "colab_c6d_next_real_slice_validation.py"
...
def main() -> int:
    ...
    print(
        "C6D_NEXT_REAL_SLICE_RUNNER_GENERATED "
