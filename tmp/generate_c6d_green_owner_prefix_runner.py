...
def generate(source_sha: str) -> str:
    ...
    replacements = (
        ...
        (
            ...
            "plus the literal localized-coordinate-to-regional-site bridge, all nine\n"
            "public axiom readouts and every repository consumer through\n"
        ...
        (
            ...
            "08_c6d_green_owner_prefix_yang_mills_core_root",
        ),
    )
