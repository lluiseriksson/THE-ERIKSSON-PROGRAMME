...
/-!
PRE-VALIDATION: source present, .olean not materialized, not verified by the
compiler. This draft extracts the existing Hilbert-bundle transport argument
...
theorem neumannFlatGeneratedCountingMass_eq_explicit_draft
...
theorem neumannFlatRetainedTerminalCountingMass_eq_explicit_draft
  ...
  exact neumannFlatGeneratedCountingMass_eq_explicit_draft
...
#print axioms YangMills.RG.neumannFlatGeneratedCountingMass_eq_explicit_draft
#print axioms YangMills.RG.neumannFlatRetainedTerminalCountingMass_eq_explicit_draft
