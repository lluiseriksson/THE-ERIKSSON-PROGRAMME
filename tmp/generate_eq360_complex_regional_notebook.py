#!/usr/bin/env python3
"""Generate the one-cell launcher for the pinned Eq. (3.60) regional gate."""
...
RUNNER_PATH = "scripts/colab_eq360_complex_regional_validation.py"
OUTPUT = ROOT / "scripts" / "colab_eq360_complex_regional_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("eq360_regional_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("EQ360_REGIONAL_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "EQ360_REGIONAL_NOTEBOOK_GENERATED "
