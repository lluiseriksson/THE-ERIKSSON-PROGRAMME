#!/usr/bin/env python3
"""Generate the one-cell launcher for a pinned Eq. (3.59) real-slice gate."""
...
RUNNER_PATH = "scripts/colab_eq359_real_slice_validation.py"
OUTPUT = ROOT / "scripts" / "colab_eq359_real_slice_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("eq359_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("EQ359_REAL_SLICE_NOTEBOOK_BASE_IMPORT_FAILED")
...
def main() -> int:
    ...
    print(
        "EQ359_REAL_SLICE_NOTEBOOK_GENERATED "
