...
/-!
Scratch-only elaboration target for Step 8b.24/P0.

This file is intentionally outside the tracked import graph.  It constructs
the two canonical fine-to-coarse prefix truncations and the proposed family
bridge from every retained physical prefix to those truncations.  Nothing in
this file has yet elaborated against the pinned toolchain; the bridge remains
static PRE-VALIDATION design rather than compiler evidence.
-/
...
theorem scratch_cmp99SourceRetainedWeightedPrefix_transport
...
theorem scratch_cmp99SourceGeneratedRetainedPhysicalTower_towerAt_eq_take
      ...
      · have htail := ih ((M : ℝ) * spacing)
        ...
        have htail' :
          ...
          simpa [Tail', regions'] using
            scratch_cmp99SourceRetainedWeightedPrefix_transport hregion
