#!/usr/bin/env python3
"""Hot diagnostic for the literal CMP89 (2.42) reflection scale dictionary."""
...
OVERLAY_SOURCE = "7314d0f57d8025f21e43c506ebd853126a396a99"
ROOT = Path("/content/hrpoly-c6d-green-owner-prefix/repo")
FILES = {
    "YangMills/RG/BalabanCMP89NeumannReflectionScaleDictionary.lean":
        "fac9e660f652a46aa801a4b1b2481af5f6198151c453bff304507a3fa2b7e874",
    "YangMills/RG/BalabanCMP89NeumannReflectionScaleDictionaryAudit.lean":
        "00f150735042d5cc6c3542e482fe27efaf6d993449922a18d59c9bc51b223a25",
}
...
def run(stage: str, command: list[str]) -> str:
    ...
    output_path = Path("/content") / f"c6d-cmp89-reflection-scale-{stage}.stdout"
...
def main() -> None:
    ...
    dependency = ROOT / "YangMills/RG/BalabanCMP89NeumannReflectionOrbitAlgebra.lean"
    if not dependency.is_file():
        raise RuntimeError("HOT_REFLECTION_ORBIT_DEPENDENCY_MISSING")
    ...
    manifest = Path("/content/c6d-cmp89-reflection-scale-paths.txt")
    ...
    run(
        ...
        [
            "lake",
            "build",
            "YangMills.RG.BalabanCMP89NeumannReflectionScaleDictionary",
        ],
    )
    audit = run(
        "audit",
    ...
    if audit.count("depends on axioms:") != 6:
