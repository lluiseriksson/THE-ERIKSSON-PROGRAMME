...
/-!
PRE-VALIDATION: this minimal repro has no materialized `.olean` and no
compiler verdict under the pinned project toolchain.
-/
...
/-- Minimal Mathlib-facing repro for the negative-orientation radius needed
by the complex Ubar recursion. -/
theorem norm_specialLinear_inv_sub_one_le_div
