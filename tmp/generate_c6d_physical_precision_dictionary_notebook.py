#!/usr/bin/env python3
"""Generate the one-cell Colab launcher for the C6d physical dictionary."""
...
RUNNER_PATH = "scripts/colab_c6d_physical_precision_dictionary_validation.py"
OUTPUT = ROOT / "scripts" / "colab_c6d_physical_precision_dictionary_validation.ipynb"


def load_base():
    spec = importlib.util.spec_from_file_location("c6d_physical_dictionary_notebook_base", BASE)
    if spec is None or spec.loader is None:
        raise RuntimeError("C6D_PHYSICAL_DICTIONARY_NOTEBOOK_BASE_IMPORT_FAILED")
