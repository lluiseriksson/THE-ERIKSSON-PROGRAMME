#!/usr/bin/env python3
"""Generate a pinned cold Colab runner for the source-specific Eq. (3.59) pair."""
...
OUTPUT = ROOT / "scripts" / "colab_eq359_complex_one_scale_average_validation.py"
