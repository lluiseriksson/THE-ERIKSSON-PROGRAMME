#!/usr/bin/env python3
"""Fail-closed verifier for the cold CMP89 directed endpoint seal."""
...
EXPECTED_RUNNER = "cmp89-eq246-directed-endpoint-envelope-cold-v1"
EXPECTED_SOURCE = "06e6be132c5e7742bb60102e890814d4961b5d2a"
...
def main() -> None:
    ...
    print("CMP89_EQ246_DIRECTED_ENDPOINT_ENVELOPE_COLD_EVIDENCE_OK")
