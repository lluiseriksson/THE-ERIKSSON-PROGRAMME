...
| lean-os-positivity | definición del objetivo RP/OS | T0 verde | push/m1-rp-core @ `7a79466` CI verde: Cauchy-Schwarz de reflexión (Glimm-Jaffe 6.2.2); RP ⟺ núcleo PSD (ambas direcciones); bond Ising/Potts ferro RP incondicional; digest madre: [`docs/satellite-interfaces/lean-os-positivity-M1.md`](docs/satellite-interfaces/lean-os-positivity-M1.md). frontier/M1 @ `26e8b7f`: 4 `sorry` statement-first, no-sorry CI rojo esperado. ERRATA de patch: ver PUSH_REPORT del madre |
...
| lean-rooted-tree-polymer-expansion | combinatoria de árboles para KP | ARCHIVADO en `e2e0dc7` (`docs: close repository as archival artifact`) | fuera del heartbeat vivo; no empujar salvo rescope humano explícito |
...
- Tipo de árbol compartido: bloquea la instanciación de GraftingProvider en
  lean-connes-kreimer; `lean-rooted-tree-polymer-expansion` queda como artefacto
  archivado de referencia, no como dependencia viva. Cualquier rescope requiere
