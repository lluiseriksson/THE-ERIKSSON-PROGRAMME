...
![Core build](https://img.shields.io/badge/lake_build_YangMillsCore-green_(8405_jobs)-success)
...
```bash
lake build YangMillsCore          # the verified core — green, 8405 jobs
...
core build remains
`lake build YangMillsCore` green at **8405 jobs**.
...
```mermaid
graph TD
    subgraph core["YangMillsCore  (8405 jobs, oracle-clean)"]
...
| Build the core | `lake build YangMillsCore` | `Build completed successfully (8405 jobs)` |
