...
![Core build](https://img.shields.io/badge/lake_build_YangMillsCore-green_(8440_jobs)-success)
...
```bash
lake build YangMillsCore          # the verified core — green, 8440 jobs
...
core build remains
`lake build YangMillsCore` green at **8440 jobs**.
...
```mermaid
graph TD
    subgraph core["YangMillsCore  (8440 jobs, oracle-clean)"]
...
| Build the core | `lake build YangMillsCore` | `Build completed successfully (8440 jobs)` |
