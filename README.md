...
What is now true inside the current repository semantics:
...
|---|---|---|
| `BalabanCouplingRecursion.lean` | `asymptotic_freedom_implies_beta_growth` | Legacy old-route P91 growth statement |
