...
![Core build](https://img.shields.io/badge/lake_build_YangMillsCore-green_(8255_jobs)-success)
...
```bash
lake build YangMillsCore          # the verified core — green, 8255 jobs
...
```mermaid
graph TD
    subgraph core["YangMillsCore  (8255 jobs, oracle-clean)"]
...
| Build the core | `lake build YangMillsCore` | `Build completed successfully (8255 jobs)` |
