...
![Core build](https://img.shields.io/badge/lake_build_YangMillsCore-green_(8257_jobs)-success)
...
```bash
lake build YangMillsCore          # the verified core — green, 8257 jobs
...
```mermaid
graph TD
    subgraph core["YangMillsCore  (8257 jobs, oracle-clean)"]
...
| Build the core | `lake build YangMillsCore` | `Build completed successfully (8257 jobs)` |
