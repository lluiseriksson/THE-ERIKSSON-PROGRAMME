...
![Core build](https://img.shields.io/badge/lake_build_YangMillsCore-green_(8438_jobs)-success)
...
```bash
lake build YangMillsCore          # the verified core — green, 8438 jobs
...
core build remains
`lake build YangMillsCore` green at **8438 jobs**.
...
```mermaid
graph TD
    subgraph core["YangMillsCore  (8438 jobs, oracle-clean)"]
...
| Build the core | `lake build YangMillsCore` | `Build completed successfully (8438 jobs)` |
