...
SUPPORT_SOURCE = '1db42284358feffc281d9c2d28b3dca1d26db64d'
...
PINS = {
    "tmp/NeumannImageRectangleCoverageDraft.lean": "b98c15bb8e5ff2c260f82dda42fde71b588cf138827bf6f871126f8bf83c113c",
...
def main():
    ...
    assert sha(Path('/content/neumann-image-rectangle-hot-v1-evidence.tar.gz').read_bytes()) == 'e0f2e5f6088cb1b48dabe4401da00a60316523ae680897d8ef0ad4d8b88d4909', 'PREVIOUS_FAILURE_PRESERVED'
    OUT.mkdir()
    ...
    try:
        ...
        for path, digest in PINS.items():
            ref = SOURCE if path == 'tmp/NeumannImageRectangleCoverageDraft.lean' else SUPPORT_SOURCE
        ...
        assert sha(repro) == '44b702e431a8d20fbcb5115a510bf721e32d1260a0b7e90c5cf839860881978f', 'REPRO_HASH'
