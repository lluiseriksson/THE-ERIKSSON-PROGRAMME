...
def main():
    ...
    try:
        ...
        for n,h in parents.items():
            origins={'NeumannDiagonalTransportRepro.olean':'neumann-diagonal-transport-repro-v2','NeumannActualCoordinateSolutionDraft.olean':'neumann-actual-coordinate-solution-hot-v1','NeumannCoordinateEndpointPhaseDraft.olean':'neumann-coordinate-endpoint-phase-hot-v1'}
        ...
        for name,path,digest in [('NeumannActualCoordinateGreenIntegrandDraft.lean','tmp/NeumannActualCoordinateGreenIntegrandDraft.lean',PIN),('axiom-gate.py','scripts/full_green_owner_exact_axiom_gate.py',GATE)]:
        ...
        source=scratch/'NeumannActualCoordinateGreenIntegrandDraft.lean'
        ...
        text=run('physical',['lake','env','lean','-o',str(OUT/'NeumannActualCoordinateGreenIntegrandDraft.olean'),str(source.relative_to(ROOT))])
