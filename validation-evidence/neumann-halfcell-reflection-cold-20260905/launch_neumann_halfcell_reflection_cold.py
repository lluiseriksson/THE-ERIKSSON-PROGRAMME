"""One-shot launcher for the three-name half-cell block geometry intermediate cold gate.
...
WORK = Path('/content/neumann-halfcell-block-reflection-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-halfcell-block-reflection-cold-v1-preservation-20260905.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_halfcell_reflection_cold.py': (
        'ab13c0e7526c41cb330b895404902e75d5663536',
        'd4e8ccfca6cbb6845506cb6f0dc31fb43bc49245db4c2ad52d0d5a70492be9e0'),
    'verify_neumann_halfcell_reflection_cold.py': (
        'ab13c0e7526c41cb330b895404902e75d5663536',
        'bf28ff31a459dd761dceca1a5d91f96d7c51d62c07f6f1aaf40c5abf38258159'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_halfcell_reflection_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_halfcell_reflection_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_halfcell_reflection_cold.py')
