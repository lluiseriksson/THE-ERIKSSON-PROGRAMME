"""Bounded canonical-Neumann finite-action HOT v3; parent cold independently sealed.

Parent-cold pins are taken from seal f45673a8, ledger 1158.
...
SOURCE = '8aa5fe1ff3d166ad67debbda3aa4a23ff659950c'
BASE = '9bb957757b6454871eaea6e26aed8c95dc576b3c'
REV = 'neumann-canonical-precision-offsets-hot-v3'
...
PINS = {
    ...
    "tmp/NeumannCanonicalPrecisionOffsetActionDraft.lean": "418d484ad56074c578ca45385e00eda680063376be4ded7a2933c8514d0ac94c",
    "tmp/NeumannCanonicalPrecisionOffsetActionRepro.lean": "09b8485407da2cad7f76188efbaa2537683be07616494e0e329704a0e9d7599a"
}
...
# Parent evidence verified before this runner was published.
PARENT_OUTER_SHA = 'fa07a48aff7657c6640452942663140d0d93b9355aca526290dbadb6a378120f'
REVIEW_REF = 'f45673a844ee5eddace0fc1cc9d433722918b517'
REVIEW_PATH = 'validation-evidence/neumann-mass-offsets-cold-20260906/independent-local-verification.json'
REVIEW_HASH = '10670b676cc5b381734f10a4fae3fbbceeaa611cee8a5d93ef947f8f9fbcb1ad'
PARENT_OLEAN_HASH = '6100f1c532c60459b389add5703894bf9c4ed2368809cdad10278919e7e2528b'
...
def main():
    ...
    previous = Path('/content/neumann-canonical-precision-offsets-hot-v2-evidence')
    previous_result = json.loads((previous / 'result.json').read_text())
    assert sha(Path(str(previous) + '.tar.gz').read_bytes()) == 'e2f8ae44a8495c323d91c4bc87442512869819ed72c4e4ec417125dfab905b92', 'PREVIOUS_FAILURE_ARCHIVE'
    assert previous_result['status'] == 'FAIL' and previous_result['source'] == '5fa96640891aa7fc980b4e27a77c08e85bf6909f', 'PREVIOUS_FAILURE_SOURCE'
    assert previous_result['records'][-1]['stage'] == 'physical_draft' and previous_result['records'][-1]['exit'] == 1, 'PREVIOUS_ELABORATION_ERROR'
