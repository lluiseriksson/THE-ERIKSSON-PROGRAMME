...
BLOBS = {
    "YangMills/RG/NeumannIntegerImageCountingKernel.lean": "97bcf8e33e2f6b2a66b9aad743d14cf5cb7e2e44b49f84da1649576d026ba23c",
    "YangMills/RG/NeumannIntegerImageCountingKernelAudit.lean": "44413b52496f7d84ea4b6aa25d8eb148dc0769ad84ccff0d97db6223fe0d4e3d"
}
NAMES = {
    "reflection_audit": [
        "YangMills.RG.neumannIntegerHalfCellOwner",
        "YangMills.RG.neumannIntegerTranslatedOwner",
        "YangMills.RG.neumannIntegerReflectedOwner",
        "YangMills.RG.neumannIntegerBlockOwner_image",
        "YangMills.RG.neumannIntegerReflectionImage_injective",
        "YangMills.RG.neumannIntegerBlockOwner_image_eq_iff",
        "YangMills.RG.neumannIntegerCountingIndicator_image"
    ]
}
...
COMMANDS = {
    "reflection_focal": [
        "lake",
        "build",
        "YangMills.RG.NeumannIntegerImageCountingKernel"
    ],
    "reflection_audit": [
        "lake",
        "env",
        "lean",
        "YangMills/RG/NeumannIntegerImageCountingKernelAudit.lean"
    ]
}
...
def verify(files, gate, old):
    ...
    require(contract.get('source_sha') == SOURCE and
            ...
            'GATE_CONTRACT')
    owner = json.loads(files['neumann-integer-image-promoted-cold-contract.json'])
    for field, value in dict(source_sha=SOURCE,
            parent_diagnostic_source='8a0714a034be31c6f4f25243e1f1c2c2fc88431f',
        parent_diagnostic_archive_sha256='49496a93f1dfbab8abcae5ea09cac7c816643b9634225acdc247d9c2745b1c28',
    ...
    expected_files = {'evidence.json', 'gate-contract.json', 'neumann-integer-image-promoted-cold-contract.json', 'preflight.json'}
    indexed = {}
    for r in records:
        stage = r['stage']
        indexed[stage] = r
    ...
    require(set(production) == set(["NeumannIntegerImageCountingKernel.olean"]), 'PRODUCTION_OUTPUT_SET')
...
def self_test(gate, old):
    ...
    files['neumann-integer-image-promoted-cold-contract.json'] = json.dumps(dict(source_sha=SOURCE,
        parent_diagnostic_source='8a0714a034be31c6f4f25243e1f1c2c2fc88431f',
        parent_diagnostic_archive_sha256='49496a93f1dfbab8abcae5ea09cac7c816643b9634225acdc247d9c2745b1c28',
        project_build_cache_restored=False,
        durable_base_commit='ddf6fdc1882edddbf063389aab4d455a8ed30801',
    ...
    production = {}
    for name in ["NeumannIntegerImageCountingKernel.olean"]:
    ...
    print('NEUMANN_INTEGER_IMAGE_VERIFIER_SELF_TEST=PASS synthetic=1 rejected=' + str(len(bads)))
...
def main():
    ...
    print('NEUMANN_INTEGER_IMAGE_COLD_EVIDENCE_VERIFIED')
