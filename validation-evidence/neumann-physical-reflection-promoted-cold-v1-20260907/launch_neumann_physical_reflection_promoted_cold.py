"""One-shot launcher for the 52-name physical reflection intermediate cold gate.
...
WORK = Path('/content/neumann-physical-reflection-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-physical-reflection-promoted-cold-v1-preservation-20260907.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_physical_reflection_promoted_cold.py': (
        'acdc7db315eb00690296c4fe1d55f3deda4f81cb',
        '67ff61519fcd7c4cf45af6a6eeadd45741434c1d02c4cd8bc7687f317326b0a4'),
    'verify_neumann_physical_reflection_promoted_cold.py': (
        'acdc7db315eb00690296c4fe1d55f3deda4f81cb',
        'c0d54f929d54f4d52ff94019f09ab3b9c70160755c8969b1a11faa0933985787'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_physical_reflection_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_physical_reflection_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_physical_reflection_promoted_cold.py')
