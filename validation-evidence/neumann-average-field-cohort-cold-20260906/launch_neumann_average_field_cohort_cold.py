"""One-shot launcher for the six-name averaging/field-action intermediate cold gate.
...
WORK = Path('/content/neumann-average-field-cohort-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-average-field-cohort-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_average_field_cohort_cold.py': (
        'c8ec499e1f5fce268f5c48784a6a5854f949ec5e',
        '7b9bce5013a0482406f55ce2ea55d0e95ec27e9130dd4f79dadf6929af8db0cc'),
    'verify_neumann_average_field_cohort_cold.py': (
        'c8ec499e1f5fce268f5c48784a6a5854f949ec5e',
        '973e10c9a46c413a46e922b0d0d84d77f6700de306a64f27ddefd3096bc9f1ac'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_average_field_cohort_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_average_field_cohort_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_average_field_cohort_cold.py')
