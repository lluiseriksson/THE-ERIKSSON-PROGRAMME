...
$expectedSource = '928d3b8f8c62df8590687a3ee9edc58459386ad6'
...
$expectedRunner = 'cmp89-neumann-restricted-straight-path-energy-cold-v1'
$expectedStages = @(
  ...
  'restricted_straight_path_energy_focal',
  'restricted_straight_path_energy_audit'
)
$expectedBlobs = @{
...
Write-Output 'CMP89_NEUMANN_RESTRICTED_STRAIGHT_PATH_ENERGY_COLD_EVIDENCE_OK'
