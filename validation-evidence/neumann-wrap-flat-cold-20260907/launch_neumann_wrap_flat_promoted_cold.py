"""One-shot launcher for the three-name Neumann wrap/flat intermediate cold gate.
...
WORK = Path('/content/neumann-wrap-flat-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-wrap-flat-promoted-cold-v1-preservation-20260907.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_wrap_flat_promoted_cold.py': (
        'c5a961b1a1b55d4204a9d5d413df6dc99281bca0',
        '12453664bd058ae5228cd2a92251027a1b5413cc4771fbd334ecdfe1c90ddba4'),
    'verify_neumann_wrap_flat_promoted_cold.py': (
        'c5a961b1a1b55d4204a9d5d413df6dc99281bca0',
        'e5fb5abdc9c2f2f280d20fc57dac14ec683efc748d5621ad6b4fd1ba974686e0'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_wrap_flat_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_wrap_flat_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_wrap_flat_promoted_cold.py')
