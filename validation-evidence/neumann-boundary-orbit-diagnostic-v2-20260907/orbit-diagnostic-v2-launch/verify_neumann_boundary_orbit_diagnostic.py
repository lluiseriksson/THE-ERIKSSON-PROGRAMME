...
RUNNER_HASH = '6b26d11c8d28080e5c993545b05a84c5feeb9f0bf2b62aee6bd4f57341c1b858'
...
COMMANDS = {
    ...
    'orbit_repro': ['lake','env','lean','-o',
        ...
        'tmp/NeumannBoundaryOrbitPermutationRepro.lean'],
    'clean_after': ['git','diff','--exit-code','HEAD','--','YangMills',
        'tmp/NeumannBoundaryOrbitPermutationRepro.lean','lean-toolchain','lake-manifest.json']}
...
def verify(files):
    ...
    c=json.loads(files['orbit-diagnostic-contract.json'])
    ...
    expected_files={'runner.py','durable-base.py','axiom-gate.py','evidence.json','orbit-diagnostic-contract.json','gate-contract.json','preflight.json'}
    idx={}
    for r in records:
        s=r['stage'];idx[s]=r
    ...
    outputs=c['outputs']
    require(set(outputs)=={'NeumannBoundaryOrbitPermutationRepro.olean'},'OUTPUT_SET')
