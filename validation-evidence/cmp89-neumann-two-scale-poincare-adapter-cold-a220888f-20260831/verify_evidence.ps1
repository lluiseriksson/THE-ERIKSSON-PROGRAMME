...
$expectedSource = 'a220888f02f0458b7c380c7ee920224daeeae86c'
...
$expectedRunner = 'cmp89-neumann-two-scale-poincare-adapter-cold-v1'
$expectedStages = @(
  ...
  'two_scale_poincare_adapter_focal',
  'two_scale_poincare_adapter_audit'
)
$expectedBlobs = @{
...
Write-Output 'CMP89_NEUMANN_TWO_SCALE_POINCARE_ADAPTER_COLD_EVIDENCE_OK'
