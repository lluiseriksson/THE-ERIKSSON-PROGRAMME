...
SOURCE = '18a258099534267740bb59e7b8756fdd6254b409'
BASE = '87edca6519df5b450b906e83db2ffa4fc1bd87bd'
REV = 'neumann-image-interval-hot-v2'
ROOT = Path('/content/hrpoly-neumann-integer-image-promoted-cold-v1')
OUT = Path('/content/' + REV + '-evidence')
ARCHIVE = Path(str(OUT) + '.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
PINS = {
    "tmp/NeumannImageIntervalCoverageDraft.lean": "c050da1ed5801fcddf441f5d0b07b4deaac98b585e27149d804a35897800f0a6",
...
def main():
    ...
    assert sha(Path('/content/neumann-image-interval-hot-v1-evidence.tar.gz').read_bytes()) == '600f41b23e653a53e51769e63e99c95bc6410c9955e50967395c85e0e4ebd94a', 'PREVIOUS_FAILURE_PRESERVED'
    OUT.mkdir()
    ...
    try:
        ...
        assert sha(repro) == 'c009b328de567de8a3b60d7243443cd3948d3d28f0c8c2a2f11dae52829dc8ec', 'REPRO_HASH'
