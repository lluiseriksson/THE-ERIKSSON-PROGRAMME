"""One-shot launcher for the two-name canonical Neumann precision intermediate cold gate.
...
WORK = Path('/content/neumann-canonical-precision-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-canonical-precision-promoted-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_canonical_precision_promoted_cold.py': (
        '44857de9b870e433d36b30e3a52a74b05e9a5d0d',
        '2fb80c2eaead31b34265cae09c18589396e96d032719ceba97d5d66f43bd4a43'),
    'verify_neumann_canonical_precision_promoted_cold.py': (
        '44857de9b870e433d36b30e3a52a74b05e9a5d0d',
        'cbbe53bde473bf9dc51d1dbfee8c9fc9a852aee20c70206ce6ed05c152b1f86f'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_canonical_precision_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_canonical_precision_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_canonical_precision_promoted_cold.py')
