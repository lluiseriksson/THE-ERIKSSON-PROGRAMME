...
> **CURRENCY STAMP (updated 2026-07-28; measured source checkpoint `bd2c1839`).**
> The "Ground truth as of 2026-05" below is
> a historical snapshot.  Since then the core advanced substantially (now
> **8422 jobs** and **2431 accounted oracle commands** in the latest recorded
> verification-ledger checkpoint, Mathlib pinned —
...
> Osterwalder–Seiler/transfer chain through Addendum 515, with the latest
> measured source checkpoint `bd2c1839`, on `main`)
> has a theorem-fed
