...
> **CURRENCY STAMP (updated 2026-07-30; source checkpoint 2026-07-30).**
> The "Ground truth as of 2026-05" below is
> a historical snapshot.  Since then the core advanced substantially (now
> **8463 jobs** in the latest recorded merged verification-ledger checkpoint, Mathlib pinned —
...
> merged build checkpoint `7460e035` and full-oracle record `d6282a83`, on `main`)
> has a theorem-fed
