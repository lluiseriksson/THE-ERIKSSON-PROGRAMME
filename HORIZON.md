...
> **CURRENCY STAMP (updated 2026-07-29; source checkpoint 2026-07-29).**
> The "Ground truth as of 2026-05" below is
> a historical snapshot.  Since then the core advanced substantially (now
> **8429 jobs** in the latest recorded verification-ledger checkpoint, Mathlib pinned —
...
> measured source checkpoint `c4fa6a9e`, on `main`)
> has a theorem-fed
