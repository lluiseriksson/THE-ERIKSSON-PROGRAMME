...
It is the integral of the literal Hessian difference along the radial segment,
so it is defined for every potential and carries no regularity certificate as
data. -/
noncomputable def cmp102Eq80CouplingScaledTotalTaylorResidual
  ...
  ∫ t in (0 : ℝ)..1, (1 - t) *
    (cmp116FDerivHessian
        (cmp102Eq80CouplingScaledPotential gk f) (t • B) B B -
      cmp116FDerivHessian
        (cmp102Eq80CouplingScaledPotential gk f) 0 B B)
...
theorem cmp102Eq80CouplingScaledTotalTaylorResidual_eq_radial
  ...
  rw [cmp102Eq80CouplingScaledTaylorResidual,
    inner_cmp116RadialTaylorResidualOperator,
