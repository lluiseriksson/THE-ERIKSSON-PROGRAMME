...
/-!
# Conditioned physical equation-(2.26) terms produce Appendix-F `hraw`
...
contour family. -/
theorem cmp116Eq226ConditionedPhysicalContour_rawMetricDecay_of_boundaries
  ...
  have estimate :
    ...
    cmp116Eq226ConditionedPhysicalContour_lemma3ActivityEstimate_of_boundaries
      Dict ambient distinguished outerCarrier
