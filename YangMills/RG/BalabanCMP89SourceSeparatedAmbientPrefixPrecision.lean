import YangMills.RG.BalabanCMP89Eq234PhysicalGreenScaleDictionary
...
This file supplies the precision-side companion of the P5 Green dictionary. It fixes the bare physical mass to zero, uses the literal flowing CMP85 coefficient `a_j`, transports the resulting precision through the same full-site equivalence as P5, and transports its generated coercivity without loss. The two inverse laws identify this one precision with the one P5 Green.

No Green, inverse identity, coercivity witness, regional action estimate or window-15 inequality is accepted from the caller.
...
theorem cmp85LastPositivePrefix_succ_sourceIndex (depth : ℕ) :
...
noncomputable def cmp89SourceSeparatedFinePrefixPrecision
...
noncomputable def cmp89SourceSeparatedPrefixCoercivity
    (hL : 2 ≤ L) (depth : ℕ) (spacing epsilon a : ℝ)
    (background : GaugeConfig 4
      (cmp99RegionalLatticeSize L (2 * (K * Q)) (depth + 1)) (SUN Nc))
    (budget : CMP99SourceUbarClosedBudget 4 L Nc (depth + 1) epsilon)
  ...
  cmp85SourceGeneratedPrefixCoercivity
    (d := 4) (M := L) (N := 2 * (K * Q)) (Nc := Nc)
    (by norm_num) hL
    (cmp99SourceSeparatedGeneratedPhysicalFullCoarseRegion K Q) (depth + 1)
...
theorem cmp89SourceSeparatedPrefixCoercivity_pos
    (hL : 2 ≤ L) (depth : ℕ) {spacing epsilon a : ℝ}
    ...
    (hsmall : cmp99SourcePoincareErrorCoeff 4 L (depth + 1)
      spacing epsilon < 1) :
    0 < cmp89SourceSeparatedPrefixCoercivity hL depth
      spacing epsilon a background budget fineSmall := by
  exact cmp85SourceGeneratedPrefixCoercivity_pos
    (d := 4) (M := L) (N := 2 * (K * Q)) (Nc := Nc)
    (by norm_num) hL
    (cmp99SourceSeparatedGeneratedPhysicalFullCoarseRegion K Q) (depth + 1)
...
noncomputable def cmp89SourceSeparatedAmbientPrefixPrecision
    (hL : 2 ≤ L) (depth : ℕ) (spacing epsilon a : ℝ)
    (background : GaugeConfig 4
      (cmp99RegionalLatticeSize L (2 * (K * Q)) (depth + 1)) (SUN Nc))
    (budget : CMP99SourceUbarClosedBudget 4 L Nc (depth + 1) epsilon)
...
theorem isCoerciveCLM_cmp89SourceSeparatedAmbientPrefixPrecision
    (hL : 2 ≤ L) (depth : ℕ) {spacing epsilon a : ℝ}
    (hspacing : 0 < spacing) (ha : 0 < a)
    (background : GaugeConfig 4
      (cmp99RegionalLatticeSize L (2 * (K * Q)) (depth + 1)) (SUN Nc))
    ...
    IsCoerciveCLM
      (cmp89SourceSeparatedAmbientPrefixPrecision hL depth
        spacing epsilon a background budget fineSmall)
      (cmp89SourceSeparatedPrefixCoercivity hL depth
        spacing epsilon a background budget fineSmall) := by
  let e :
...
identity. -/
theorem cmp89SourceSeparatedAmbientPrefixPrecision_comp_green
    (hL : 2 ≤ L) (depth : ℕ) {spacing epsilon a : ℝ}
    (hspacing : 0 < spacing) (ha : 0 < a)
    (background : GaugeConfig 4
      (cmp99RegionalLatticeSize L (2 * (K * Q)) (depth + 1)) (SUN Nc))
    ...
    (cmp89SourceSeparatedAmbientPrefixPrecision hL depth
      spacing epsilon a background budget fineSmall).comp
        (cmp89SourceSeparatedAmbientPrefixGreen hL depth
...
the identity. -/
theorem cmp89SourceSeparatedAmbientPrefixGreen_comp_precision
    (hL : 2 ≤ L) (depth : ℕ) {spacing epsilon a : ℝ}
    (hspacing : 0 < spacing) (ha : 0 < a)
    (background : GaugeConfig 4
      (cmp99RegionalLatticeSize L (2 * (K * Q)) (depth + 1)) (SUN Nc))
  ...
  let e :
    ...
    cmp99SourceSeparatedGeneratedPhysicalFullSiteEquiv L K Q depth
  apply finitePiLpTypedKernelReindex_comp_eq_id e
  exact cmp85SourceGeneratedPrefixGreen_comp_precision
    (d := 4) (M := L) (N := 2 * (K * Q)) (Nc := Nc)
    (by norm_num) hL
    (cmp99SourceSeparatedGeneratedPhysicalFullCoarseRegion K Q) (depth + 1)
    hspacing ha 0 background budget.toRadiusChain fineSmall hsmall
