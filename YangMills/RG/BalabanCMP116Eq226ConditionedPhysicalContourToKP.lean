...
/-- End-to-end bounded-hole KP criterion for the corrected conditioned
physical contour source.  No termwise bound, `hraw`, residual `H#` estimate,
or KP conclusion is supplied. -/
theorem cmp116Eq226ConditionedPhysicalContour_KPCriterion_of_boundaries
  ...
  have raw_decay :
    ...
    simpa [F, physicalActivity] using
      (cmp116Eq226ConditionedPhysicalContour_rawMetricDecay_of_boundaries
