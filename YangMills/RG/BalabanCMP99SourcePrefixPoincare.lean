import YangMills.RG.BalabanCMP99SourceCanonicalPrefixTower
/-!
elaboration target for Step 8b.24/P1.
...
theorem cmp99SourcePoincareEnergyCoeff_le_succ
...
theorem cmp99SourcePoincareEnergyCoeff_monotone
    (spacing epsilon : ℝ) :
    Monotone (fun depth ↦
      cmp99SourcePoincareEnergyCoeff d M depth spacing epsilon) :=
  monotone_nat_of_le_succ fun depth ↦
    cmp99SourcePoincareEnergyCoeff_le_succ depth spacing epsilon

/-- Adjacent-depth monotonicity of the generated Poincare error ledger. -/
theorem cmp99SourcePoincareErrorCoeff_le_succ
    (depth : ℕ) (spacing epsilon : ℝ) :
  ...
  | succ depth ih =>
      ...
      · exact mul_le_mul_of_nonneg_right
          (cmp99SourcePoincareEnergyCoeff_le_succ depth
            ((M : ℝ) * spacing)
            (cmp99SourceUbarNextFineRadius d M epsilon))
...
theorem cmp99SourcePoincareErrorCoeff_monotone
    (spacing epsilon : ℝ) :
    Monotone (fun depth ↦
      cmp99SourcePoincareErrorCoeff d M depth spacing epsilon) :=
  monotone_nat_of_le_succ fun depth ↦
    cmp99SourcePoincareErrorCoeff_le_succ depth spacing epsilon
...
definitionally zero. -/
theorem cmp99SourcePoincareEnergyCoeff_pos
...
theorem cmp99SourcePoincareErrorCoeff_lt_of_le_depth
  ...
  (cmp99SourcePoincareErrorCoeff_monotone
...
theorem cmp99SourceGeneratedRetainedPhysicalTower_prefix_poincare
    (hd : 2 ≤ d) (hM : 2 ≤ M)
  ...
  have hsmallR :
    ...
    cmp99SourcePoincareErrorCoeff_lt_of_le_depth hrle hsmall
  ...
  have hprefix :=
    cmp99SourceGeneratedRetainedPhysicalTower_towerAt_eq_take
