...
/-!
scalar normalization gate for CMP85 (2.41)--(2.42).
...
theorem cmp85RecurrenceBeta_mul_add_eq_mul
    {a L spacingJ : ℝ} (ha : 0 < a) (hL : 0 < L)
    (hspacing : 0 < spacingJ) (n : ℕ) :
    cmp85RecurrenceBeta a L spacingJ n *
        (cmp85RecurrenceB a L spacingJ n +
          cmp85RecurrenceC a L spacingJ) =
      cmp85RecurrenceB a L spacingJ n *
        cmp85RecurrenceC a L spacingJ := by
  ...
  unfold cmp85RecurrenceBeta cmp85RecurrenceB
    cmp85RecurrenceC
...
theorem cmp85Recurrence_add_eq_eq241Coefficient
    {a L spacingJ : ℝ} (ha : 0 < a) (hL : 0 < L)
    (hspacing : 0 < spacingJ) (n : ℕ) :
    cmp85RecurrenceB a L spacingJ n +
        cmp85RecurrenceC a L spacingJ =
  ...
  have hden : 0 < a * (L ^ 2)⁻¹ +
      cmp99SourceMassParameter a L n :=
    add_pos (mul_pos ha (inv_pos.mpr (sq_pos_of_pos hL))) han
  unfold cmp85RecurrenceB cmp85RecurrenceC
  rw [cmp99SourceMassParameter_succ]
...
`a_j^2 * spacing_j^(-4)`. -/
theorem cmp85RecurrenceB_sq
    (a L spacingJ : ℝ) (n : ℕ) :
    cmp85RecurrenceB a L spacingJ n ^ 2 =
