...
/-- The actual third iterated derivative of the literal reconstructed
equation-(80) coefficient obeys the same order-four source-jet bound.  This
is the form consumed by the cutoff radial-residual theorem; unlike the
displayed trilinear extractor above, its left-hand side is the derivative
of the physical coefficient function itself. -/
theorem
  ...
  have hraw :=
    norm_iteratedFDeriv_three_cmp102PartialPropagatorJet_one_le
      Φ hΦ H Kdomain A
  have hjoint :
      ‖iteratedFDeriv ℝ 4 Φ (H, A)‖ ≤
        cmp102Eq80JointPotentialSourceJetMajorant
