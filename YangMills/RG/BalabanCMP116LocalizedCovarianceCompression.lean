...
`f04b5cb9937b12ca412ab21be5e1c35780c01836`, with Lean `v4.29.0-rc6`,
Mathlib `07642720480157414db592fa85b626dafb71355b`, focused build exit zero,
and the companion audit restricted to `{propext, Classical.choice,
Quot.sound}`.  Evidence SHA-256:
