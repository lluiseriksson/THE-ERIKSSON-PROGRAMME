import YangMills.RG.BalabanCMP85ScalarRecurrence
/-!
noncommutative algebra gate for CMP85 (2.41)--(2.42).
...
private theorem cmp85_commute_assoc
...
theorem cmp85_rightSchurBracket_eq_zero
    (b c beta : ℝ) (P S C : A)
    (hP : P * P = P)
    (hC :
        ...
        B * R - Beta * P * R + Beta * C0 * (P * P - P) * C +
          (Beta * (B + C0) - B * C0) * P * C := by
            ...
            noncomm_ring [hBP, hBS, hBC, hBC0, hBBeta, hC0P, hC0S,
              ...
              cmp85_commute_assoc hBP,
              cmp85_commute_assoc hBS,
              cmp85_commute_assoc hBC,
              cmp85_commute_assoc hBC0,
              cmp85_commute_assoc hBBeta,
              cmp85_commute_assoc hC0P,
              cmp85_commute_assoc hC0S,
              cmp85_commute_assoc hC0C,
              cmp85_commute_assoc hC0Beta,
              cmp85_commute_assoc hBetaP,
              cmp85_commute_assoc hBetaS,
              cmp85_commute_assoc hBetaC]
    _ = 0 := by rw [hR, hP0, hrec0]; noncomm_ring

set_option linter.unusedVariables false in
/-- Left-handed companion of `cmp85_rightSchurBracket_eq_zero`.
...
theorem cmp85_leftSchurBracket_eq_zero
    (b c beta : ℝ) (P S C : A)
    (hP : P * P = P)
    (hC :
