...
| F3-COUNT | Klarner BFS-tree lattice-animal count: count(n) <= C * K^n for d=4 | CONDITIONAL_BRIDGE | Recursive deletion / parent map (per AXIOM_FRONTIER v2.44.0 "remaining hard step") | LatticeAnimalCount.lean root-shell layer landed | CLAY-F3-COUNT-RECURSIVE-001 (READY priority 5) |
