...
| F3-COUNT | Klarner BFS-tree lattice-animal count: count(n) <= C * K^n for d=4 | CONDITIONAL_BRIDGE | Recursive deletion / parent map still incomplete | LatticeAnimalCount.lean v2.48.0 parent selector: `physicalPlaquetteGraphPreconnectedSubsetsAnchoredCard_rootShellParent1296_reachable`, `...ParentCode1296_spec` | Continue `CLAY-F3-COUNT-RECURSIVE-001`: iterate parent selector into deletion/word decoder |
