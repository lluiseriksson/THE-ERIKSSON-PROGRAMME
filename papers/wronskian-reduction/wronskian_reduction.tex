...
$b$ strictly decreasing with $F_b > 0$ on $(0,\pi)$ by the explicit
factorization $F_b = 2\sin t\,(2\cos^2 t + 2\cos t + 1)$, yet the
Wronskian at
...
increasing; and $F_b(t) = 3\sin t + 2\sin 2t + \sin 3t
= 2\sin t\,(2\cos^2 t + 2\cos t + 1) > 0$ on $(0,\pi)$, since the
quadratic $2y^2 + 2y + 1$ has negative discriminant. (We note in
passing that mere coefficient decrease does \emph{not} imply sine
positivity --- $\sin t + \sin 2t < 0$ near $t = \pi$ --- which is
why we give the factorization rather than cite a general positivity
theorem; for genuine positivity criteria of Vietoris type see
...
\S\S10.29, 10.41; \url{https://dlmf.nist.gov/10.29},
\url{https://dlmf.nist.gov/10.41}.
