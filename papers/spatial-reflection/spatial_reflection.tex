...
\newcommand{\anchor}{730857fb700a31409c457ff4b0d03b4582e4d2f5}
\newcommand{\osline}[3]{%
...
configuration, kernel $1$ --- and that exception is recorded rather than left to
be found.  The boundary $\beta=0$ is sharp and exhibited, not inferred.
...
\osline{SpatialReflection}{484}{gibbsPathSum\_gram\_nonneg} and
\osline{SpatialReflection}{491}{gibbsPathSum\_gram\_nonneg\_even}, with
the bilinearity that makes the matrix visible at
\osline{SpatialReflection}{459}{gibbsPathSum\_combo}.
...
\osline{SpatialReflection}{364}{symWeighted\_quadForm\_neg\_of\_neg\_beta}.
...
(\osline{SpatialReflection}{417}{spatialKernel\_posSemidef\_zero}); the
\emph{weighted} kernel is the positive scalar $w(\varnothing)$, which need not
be $1$
(\osline{SpatialReflection}{437}{symWeighted\_posSemidef\_zero}).  Both quadratic
...
Oracle commands, and answers & 2716 \\
\quad distinct declarations & 2712 \\
\quad commands listed twice & 3 \\
\quad distinct, with axiom dependencies & 2690 \\
