...
\newcommand{\anchor}{1f79a73d3b88bf055292cd48ec6ab0aff0252967}
\newcommand{\osline}[3]{%
...
\osline{SpatialReflection}{103}{sum\_iterate\_even\_nonneg}.
...
\osline{SpatialReflection}{145}{spatialKernel\_posSemidef}.
...
(\osline{SpatialReflection}{124}{act\_spatialKernel\_cons}).
...
\osline{SpatialReflection}{207}{posSemidef\_congr} and
\osline{SpatialReflection}{223}{symWeighted\_posSemidef}.
...
\osline{SpatialReflection}{237}{sum\_iterate\_odd\_nonneg}.
...
\emph{every} $\beta$
(\osline{SpatialReflection}{264}{gibbsPathSum\_nonneg\_even});
\item for $\beta\ge0$ it is non-negative at \emph{every} separation
(\osline{SpatialReflection}{273}{gibbsPathSum\_nonneg}).
\end{enumerate}
\end{theorem}
...
$c_1,\dots,c_k$,
\[
  \sum_{i,j} c_i c_j \, \bigl\langle A_i, K^{N} A_j \bigr\rangle \;\ge\; 0
\]
under the hypotheses of Theorem~\ref{thm:rp}.
\end{theorem}

\osline{SpatialReflection}{468}{gibbsPathSum\_gram\_nonneg} and
\osline{SpatialReflection}{475}{gibbsPathSum\_gram\_nonneg\_even}, with
the bilinearity that makes the matrix visible at
\osline{SpatialReflection}{443}{gibbsPathSum\_combo}.
...
\osline{SpatialReflection}{305}{gibbsPathSum\_siteSign\_eq} and
\osline{SpatialReflection}{327}{gibbsPathSum\_neg\_of\_neg\_beta}.
...
\osline{SpatialReflection}{361}{symWeighted\_quadForm\_neg\_of\_neg\_beta}.

\paragraph{The exception, recorded.}  At $L=0$ the configuration space is a
point, the kernel is the number $1$, and the form is a square at every $\beta$
(\osline{SpatialReflection}{414}{spatialKernel\_posSemidef\_zero}).  So
``exactly $\beta\ge0$'' is a statement from one site upwards.
...
Oracle commands, and answers & 2715 \\
\quad distinct declarations & 2712 \\
\quad commands listed twice & 3 \\
\quad distinct, with axiom dependencies & 2689 \\
