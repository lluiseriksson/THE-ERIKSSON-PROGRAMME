...
\textbf{What is not here.}  No Hamiltonian, no spectral gap statement for $T$,
no norm or contraction bound, no infinite volume, no continuum, no gauge theory.
...
$T$.  There is no norm or contraction bound.  There is no thermodynamic limit
and no continuum limit.  The system is a finite coupled $\Z_2$ slice, and every
statement below is a statement about it.
