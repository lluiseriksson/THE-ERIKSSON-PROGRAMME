...
it, are machine-checked theorems.  The multiplicity, characteristic-polynomial,
ordered-list, reality and Perron-ratio components of the corresponding
pre-registered gate are \textbf{not} formalised here.
