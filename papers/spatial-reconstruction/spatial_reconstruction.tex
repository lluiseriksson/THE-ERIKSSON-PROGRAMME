...
Quantity & Value \\
\midrule
Full core build & 8469 jobs, success \\
\quad same tree without this paper's modules & 8468 jobs \\
\quad predicted delta, registered before measuring & $+1$ \\
Oracle commands, and answers & 2883 \\
\quad with a non-standard axiom & 0 \\
Declarations in \texttt{SpatialOS.lean} & 65 \\
Declarations in \texttt{SpatialReconstruction.lean} & 15 \\
\quad of them in the oracle & 15 \\
