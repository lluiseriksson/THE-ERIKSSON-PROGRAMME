...
\texttt{YangMills/OS/CongruenceSpectrum.lean}.

\textbf{At the time of this draft that module has not been compiled.} The
project's environment rule of 1~August~2026 routes all compilation off the
author's desktop, and the sanctioned compute plane was unreachable when this
draft was written. Nothing in this section may be cited as verified until the
module elaborates with zero errors and zero \texttt{sorry} and every declaration
prints only the standard axioms \texttt{[propext, Classical.choice,
Quot.sound]}. This paper is not submittable before that.
