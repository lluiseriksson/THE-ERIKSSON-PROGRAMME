...
congruence concentrates on the \emph{least correlated pair}. The proof is
...
Let $M$ be symmetric with $M_{ii}=1$ and $0<\mu\le M_{ij}\le 1$ for $i\neq j$,
where $\mu=\min_{i\neq j}M_{ij}$. Then
\[
...
cone of the 38 endpoints, so those endpoints certify the algebra, the congruence
...
\begin{tabular}{ll}
\toprule
commit & \texttt{c01a451e} \\
module \texttt{sha256} & \texttt{d6e120d62e7b033dfd7936de} \\
                       & \texttt{892c5772a470975c0a2a89e08a3c61d0f13e4313} \\
...
axiom oracle & 38/38 declarations on \texttt{[propext, Classical.choice, Quot.sound]} \\
\texttt{sorryAx} & none \\
\bottomrule
\end{tabular}
\end{center}
