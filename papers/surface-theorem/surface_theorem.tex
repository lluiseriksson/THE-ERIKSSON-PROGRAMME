...
certifies the same interval with $53$ boxes and both passes, with source hash
and runtime versions recorded in the transcript). Bessel enclosures use the positive
