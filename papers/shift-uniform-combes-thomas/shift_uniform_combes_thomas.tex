...
\date{August 1, 2026 -- research preprint, version 0.3.1
...
\end{center}
This version 0.3.1 is a documentation-only revision that prints those package
identifiers in the PDF.  It changes no Lean theorem module and claims no new
mathematical result.
...
\end{verbatim}
The development contains no \lean{sorry} in the two modified modules.
