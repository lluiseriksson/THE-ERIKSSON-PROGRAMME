...
\newcommand{\anchor}{d95d14af3433335c841056b5cd3c8ce3c21eeda9}
\newcommand{\osline}[3]{%
...
\osline{SpatialOS}{300}{osPairingBond\_nonneg}, which is
...
\osline{SpatialOS}{438}{osPairingBond\_gram} and
\osline{SpatialOS}{467}{osPairingBond\_gram\_nonneg}, with the cross form at
\osline{SpatialOS}{360}{osPairingBondCross}, its factorisation at
\osline{SpatialOS}{386}{osPairingBondCross\_eq}, the linearity of the collapse at
\osline{SpatialOS}{373}{collapse\_sum}, and the four-fold reindexing the assembly
needs stated on its own at \osline{SpatialOS}{333}{sum\_comm4}.  Positivity is
...
(\osline{SpatialOS}{497}{osPairingSiteCross\_eq}), and its Gram matrix is positive
semidefinite at \emph{every} $\beta$, since only $w>0$ enters:
\osline{SpatialOS}{521}{osPairingSite\_gram} and
\osline{SpatialOS}{545}{osPairingSite\_gram\_nonneg}, using the three-fold
reindexing at \osline{SpatialOS}{351}{sum\_comm3}.
...
Oracle commands, and answers & 2779 \\
\quad distinct declarations & 2776 \\
\quad commands listed twice & 3 \\
\quad distinct, with axiom dependencies & 2752 \\
\quad distinct, axiom-free & 24 \\
Declarations in this module & 27 \\
\quad of them in the oracle & 27 \\
...
The oracle counters close: $2752+24=2776$ and $2776+3=2779$, the three repeats
