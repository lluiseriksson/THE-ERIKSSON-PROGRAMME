...
reconstruction \cite{OsterwalderSeiler}: reflection positivity of the measure
...
the machinery above; the value $(\tanh\beta)^n$ is classical.  The verification
...
root is \repofile{YangMillsCore.lean}{YangMillsCore.lean}.  The judges of
