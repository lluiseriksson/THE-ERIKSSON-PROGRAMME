...
\newcommand{\anchor}{3843435533c573a0fbca32c4da691c20d1a5b247}
\newcommand{\osline}[3]{%
...
is reported as \textbf{not established}.  At constant source weight the spatial
slices are independent, so what is proved here is a statement about a product
measure; that is exactly why it is reachable, and it is said here rather than
left to be noticed.  Reflection positivity is
...
\osline{SpatialUniform}{105}{norm\_act\_le\_of\_rowSum}.
...
\osline{SpatialUniform}{340}{spatialKernel\_fluct\_bound}, from the squared
form \osline{SpatialUniform}{198}{spatialKernel\_fluct\_sq}, which is what the
...
\osline{SpatialUniform}{189}{tanh\_mul\_z2Norm}.
...
\osline{SpatialUniform}{426}{spatialKernel\_specGap\_eq}.
...
mean zero (\osline{SpatialUniform}{398}{sum\_siteSign}), it is nonzero, and
...
\osline{SpatialUniform}{521}{gibbs\_decay\_extent\_free\_rate}, composing
...
\osline{SpatialUniform}{633}{gibbsCorr\_one\_uniform\_bound}.
...
Oracle commands, and answers & 2694 \\
\quad distinct declarations & 2691 \\
\quad commands listed twice & 3 \\
\quad distinct, with axiom dependencies & 2668 \\
