...
only), with finite \texttt{decide} instances for $r\le4$ and exact
rational arithmetic for $r\le6$ as independent audits; the general
proof is a one-line character computation, included for completeness.
\end{abstract}
