...
as well as the tensorization, hyperbolic-addition, and coordinate-averaging
steps; the classical analytic Birkhoff--Hopf input remains external.
\end{abstract}
...
Dobrushin maximum; factorization of projective cross-ratios and preservation
...
source SHA-256 & \texttt{f2df04ae3b3f8f06730ab33b5d6e25673b3ae822d0727db4e925045fdf5cde65} \\
module SHA-256 & \texttt{8196837adae2215bb3a85f92bd317531a867121672cc2629efb5af68540c8ffe}
\end{tabular}
\end{center}
Both module compilation and a separate importing file had exit code zero.  A
second importing file explicitly checked the pairwise and kernel comparison
theorems and materialized with SHA-256
\texttt{caefea43e2e8a1e8676728ecfbffec4102cf89cef8297c2c5f932c8e16558209}.

The pairwise probability theorem and its realized-maximum kernel lift are now
formalized end to end.  This is still not an end-to-end formalization of every
