...
instantiated with the genuine matricial adjoint model.  The headline theorem is the \emph{wall}: under the block
...
The wall is a theorem about \emph{one specific
