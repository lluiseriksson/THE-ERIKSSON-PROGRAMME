...
\emph{subspace} is meagre in general, so pointwise bounds on it yield no
uniform bound.  Powers do not suffice: $B = S^2/\|S\|^2$ is a positive
contraction with $\|B\| = 1$ and $B^n v \to 0$ for every $v$ --- exactly
what multiplication by $x$ on $L^2[0,1]$ does --- so no contradiction is
available from norms alone.  The resolvent route stalls: $v \in
