...
\newcommand{\anchor}{bd86ee2eeff8c064cbe1322526ed40a3de0dca90}
\newcommand{\osline}[3]{%
...
(\osline{SpatialSpectral}{345}{perp\_invariant\_eigen}); the scalar drops out
because the pairing is bilinear.  Iterating gives
\osline{SpatialSpectral}{358}{iterate\_norm\_le\_specGap}.
...
\osline{SpatialSpectral}{388}{gibbs\_pathSum\_bound\_unconditional}.
...
\osline{SpatialSpectral}{429}{gibbs\_pathSum\_relative\_decay},
\osline{SpatialSpectral}{301}{specRatio\_lt\_one},
\osline{SpatialSpectral}{324}{norm\_act\_normalizedKernel\_le}.
...
(\osline{SpatialSpectral}{455}{exists\_nonzero\_dressed\_fluctuation}).
\end{remark}
