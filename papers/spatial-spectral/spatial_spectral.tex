...
\newcommand{\anchor}{3297e07105c1bf25e3a57d2d61c7126f340c74d3}
\newcommand{\osline}[3]{%
...
$\mathrm{specRatio}^{N_0} < c^{2}/2(\|u\|^{2}+1)$, not given as a closed
...
We prove the inequality $\|Ku\|\le\mathrm{specGap}\|u\|$, and
(§\ref{sec:sharp}) that it is \emph{attained}, which together say that
$\mathrm{specGap}$ is the operator norm on the fluctuation sector.  What we do
not do is introduce that norm as a defined object and prove an equation about
it.
