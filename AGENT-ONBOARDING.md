...
> `YangMillsCore` green at **8401 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8401 jobs at the latest recorded checkpoint; fast if cache is warm
```
