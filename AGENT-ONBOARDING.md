...
> `YangMillsCore` green at **8407 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8407 jobs at the latest recorded checkpoint; fast if cache is warm
```
