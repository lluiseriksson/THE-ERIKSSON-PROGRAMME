...
> `YangMillsCore` green at **8400 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8400 jobs at the latest recorded checkpoint; fast if cache is warm
```
