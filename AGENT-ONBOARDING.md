...
> `YangMillsCore` green at **8398 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8398 jobs at the latest recorded checkpoint; fast if cache is warm
```
