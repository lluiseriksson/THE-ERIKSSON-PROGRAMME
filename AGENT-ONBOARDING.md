...
> `YangMillsCore` green at **8426 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8426 jobs at the latest recorded checkpoint; fast if cache is warm
```
