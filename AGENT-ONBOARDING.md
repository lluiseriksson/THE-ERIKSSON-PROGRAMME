...
> `YangMillsCore` green at **8410 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8410 jobs at the latest recorded checkpoint; fast if cache is warm
```
