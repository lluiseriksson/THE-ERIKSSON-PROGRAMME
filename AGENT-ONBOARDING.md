...
> `YangMillsCore` green at **8397 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8397 jobs at the latest recorded checkpoint; fast if cache is warm
```
