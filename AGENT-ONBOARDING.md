...
> `YangMillsCore` green at **8411 jobs**.  The live frontier is `hRpoly`, the
...
lake build YangMillsCore  # 8411 jobs at the latest recorded checkpoint; fast if cache is warm
```
