...
Oracle: [propext, Classical.choice, Quot.sound, YangMills.~~bakry_emery_lsi~~ **ELIMINATED C124**, YangMills.~~balaban_rg_uniform_lsi~~ **PROVED C129** (Holley-Stroock; now a theorem)
  holleyStroock_sunGibbs_lsi **FRONTIER C129** (Holley-Stroock perturbation axiom), YangMills.~~sun_bakry_emery_cd~~ **ELIMINATED C126**, YangMills.~~sz_lsi_to_clustering~~ **ELIMINATED C125**].
