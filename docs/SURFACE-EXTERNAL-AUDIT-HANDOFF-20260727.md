...
authoritative audit exposed the old gap `[81,86]`.  Eight preregistered
rescue-300 units now cover `[81,83]` with independent production/replay pairs.
The remaining authoritative gap is `[83,86]`.
