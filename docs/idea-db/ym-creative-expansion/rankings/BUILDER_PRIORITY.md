...
1. **Eq. (2.31) source membership iff** — highest real payoff because consumers already exist.
2. **Metric stitching toy lemma** — low-risk theorem useful for Appendix F/Eq. (2.37).
