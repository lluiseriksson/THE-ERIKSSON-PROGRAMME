# Mission OC_026_rawsource_field_order_gate

Proof card: `proof.rawsource.m3.live-fields.v2`

Add an automated gate that checks the declared field order before patch acceptance.
