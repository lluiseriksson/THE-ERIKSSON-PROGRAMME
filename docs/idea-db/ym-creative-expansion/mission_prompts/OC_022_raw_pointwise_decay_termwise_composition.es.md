...
Proof card: `proof.raw-pointwise-decay.termwise.v2`

Feed termwise estimate and raw_pointwise_decay only after activity identity plus Eq. 2.29/2.31/2.37 dictionaries are accounted for.
