...
The owner reported in the Codex task on 2026-08-01 that all nine replacement
forms in the audited owner sequence had been sent.  The public ai.viXra pages
still exposed the prior versions when checked the same day.  Accordingly these
records are **ENVIADO/PENDIENTE**, not `PUBLICADO`.
...
|---:|---|---|---|---|---|
| 1 | `2602.0052` | v3 | ENVIADO/PENDIENTE | v2 | NOT RECORDED |
| 2 | `2602.0036` | v3 | ENVIADO/PENDIENTE | v2 | NOT RECORDED |
| 3 | `2602.0033` | v3/R30 | ENVIADO/PENDIENTE | v2 | NOT RECORDED |
| 4 | `2602.0085` | v2 | ENVIADO/PENDIENTE | v1 | NOT RECORDED |
| 5 | `2602.0084` | v2 | ENVIADO/PENDIENTE | v1 | NOT RECORDED |
| 6 | `2602.0035` | v2 | ENVIADO/PENDIENTE | v1 | NOT RECORDED |
...
pending.  Do not resend a form merely because ai.viXra processes the nine items
