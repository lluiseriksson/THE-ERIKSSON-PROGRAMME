# CWIN=3/2 scaled-bulk width-1/4 continuation VI
...
```text
[701/16,705/16], [705/16,709/16], [709/16,713/16], [713/16,717/16].
```

Each requires independent production/replay, exact contiguous t coverage, and
strictly negative outward Arb upper endpoints. These rows remain candidate-only
and do not imply `(H_tail)` or promote G2/G6.
