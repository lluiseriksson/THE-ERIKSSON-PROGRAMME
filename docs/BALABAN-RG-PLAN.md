...
| **B4-Ū** | Lift B4 to the field map `Ū` itself (each coarse bond `c` averages the contours `Γ_{c,x}`; B4 applies pointwise). | CMP 98 (11) | `Ubar_gaugeAct`. | open (needs `Ū`, B3-full analytic) |
