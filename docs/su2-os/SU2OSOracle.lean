...
/-!
Independent oracle for the SU(2) Wilson reflection-positivity producer.

This file is intentionally separate from the global project oracle: the task
does not own `YangMillsCore.lean` or `oracle_check.lean`.
-/
