...
- `kpRadiusAtUnit_iff_checkedWindow` identifies the unit-slice proposition;
...
PR 35 / codex/su2-wilson-reflection-positivity:
  4385e3767cb3a9f8a27c83f70849e69b89dc92a5
```

SU2 therefore has a public artefact and a separate clean-checkout audit.
CONT-C0 remains absent from public refs.
