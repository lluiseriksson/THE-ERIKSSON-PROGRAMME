...
| **P2c** | **Type-local F.1 algebra and ultralocal independence** (`RG/LocalFunctional.lean`, `RG/RawMayerWithHoles.lean`, `RG/OmegaConnectedCover.lean`, `RG/UltralocalFactorization.lean`, `RG/MayerCoverFactorization.lean`): local activities, raw Mayer factors, Ω-connected cover products, and product-measure factorization of disconnected fluctuation-support components. | code — finite algebra/measure theory | **DONE** (core 8283) |
