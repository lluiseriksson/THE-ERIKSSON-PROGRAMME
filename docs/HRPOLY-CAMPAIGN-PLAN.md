...
| **P2b-ii-c** | **Discrete modified-metric summability** (`discreteModifiedMetric_weight_summable_of_skeleton_count`, `RG/ModifiedMetric.lean`): prove that the skeleton-growth series converges under sufficient exponential metric decay. | code — combinatorics | **DONE** (core 8264) |
