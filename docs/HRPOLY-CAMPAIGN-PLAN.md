...
**Cluster-level substrate update (2026-06-19, Addenda 113–119).**  The
...
and tilted norm-bound APIs, plus the local versions of skeleton-tail
summability and the pre-metric skeleton-pinned bound.  This does **not** prove
the P3/P4 activity-decay theorem; it proves the exact summability consumer
interface that P3/P4 must feed.
