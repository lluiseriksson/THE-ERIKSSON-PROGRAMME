...
- `audit_surface_g2_relay_admissibility.py`: after fresh terminal production
  ...
  `3393/32`. The remaining authoritative gap is exactly
  `[3393/32,1000/9]`; the relay remains `RELAY_LEMMA_UNPROVED`.
...
`surface-scaled-bulk-cwin3p2-post1635-terminal-20260725.json` (ten rescue-300
units, 4,558 t-rows, `[1635/16,3393/32]`). All are direct-sign evidence only and
