...
`[217/2,435/4]`, `[435/4,109]`, `[109,437/4]`, `[437/4,219/2]`, and
`[219/2,439/4]` completed with strict-negative rows and byte-identical
production/replay pairs; independent validators passed. The candidate-only
union now reaches `439/4`; the residual finite-beta gap is `[439/4,1000/9]`.
This does not
