...
- `audit_surface_g2_relay_admissibility.py`: after fresh terminal production
  ...
  `3273/32`. The remaining authoritative gap is exactly
  `[3273/32,1000/9]`; the relay remains `RELAY_LEMMA_UNPROVED`.
...
`surface-scaled-bulk-cwin3p2-post1635-terminal-20260725.json` (two rescue-300
units, 480 t-rows, `[1635/16,3273/32]`). Both are direct-sign evidence only and
explicitly make no H-tail/G2/G6 promotion. The authoritative audit now sees
472 admissible units and one remaining beta gap, `[3273/32,1000/9]`.
