...
- `audit_surface_g2_relay_admissibility.py`: after fresh terminal production
  ...
  `3361/32`. The remaining authoritative gap is exactly
  `[3361/32,1000/9]`; the relay remains `RELAY_LEMMA_UNPROVED`.
...
`surface-scaled-bulk-cwin3p2-post1635-terminal-20260725.json` (eight rescue-300
units, 3,466 t-rows, `[1635/16,3361/32]`). All are direct-sign evidence only and
explicitly make no H-tail/G2/G6 promotion. The authoritative audit now sees
478 admissible units and one remaining beta gap, `[3361/32,1000/9]`.
