...
| Balaban CMP96 | Paper completo localizado en la antología privada; (2.39), (2.40), (2.43) y (2.44) confirmadas visualmente para la ruta directa del defecto regional; diccionario separado de covarianza/raíz aún abierto | `structured_partial` | Formalizar la ruta fuente-específica hasta `O(M^-1)` y, por separado, localizar el teorema exacto de covarianza/raíz |
| Balaban CMP98 | PDF primario limpio de 2.629.073 bytes localizado en Drive y materializado con SHA-256 `03409AD8…`, idéntico al source packet. Renders a 300 dpi confirman visualmente Prop. 2 y (52)–(53) en p. 26, (97) en p. 32, (102)–(103) en p. 33, Prop. 4 y (134)–(135) en p. 38, la uniformidad en `k` y (136) en p. 39, y (160)–(162) en p. 42. El stub canónico local sigue siendo HTML Incapsula y queda rechazado | `visual_confirmed` | Construir el diccionario finito exp/log de la recursión analítica `Ubar`/`U_k`; Prop. 4 no debe reinterpretarse como una cota libre sobre `UbarDeviation` |
...
| Balaban CMP102 variational (pp. 277-309) | PDF primario y renders privados registrados; Eqs. (22), (44)-(46), (78), (80) y (142) visualmente confirmadas; (80) coincide exactamente con `cmp102Eq80GlobalPotential` | `visual_confirmed` | Diccionario `D = C^(2) + D_3` de (78), y después `A'`, `Delta_1`, `H`, `U_k` hacia `wilson_hessian_identification` |
| Balaban CMP102 UV3D (pp. 255-275) | Clave bibliográfica separada para evitar confundir sus ecuaciones (1)-(71) con el paper variacional consecutivo | `located` | Adquirir fuente primaria limpia antes de atribuir cualquier fórmula; citar por clave y no solo por volumen |
