...
| Balaban CMP98 | PDF primario limpio de 2.629.073 bytes localizado en Drive y materializado con SHA-256 `03409AD8…`, idéntico al source packet. Renders a 300 dpi confirman visualmente Prop. 2 y (52)–(53) en p. 26, (97) en p. 32, (102)–(103) en p. 33, Prop. 4 en p. 38 y (160)–(162) en p. 42. El stub canónico local sigue siendo HTML Incapsula y queda rechazado | `visual_confirmed` | Construir el diccionario finito de la recursión analítica `Ubar`/`U_k`; la adquisición y transcripción fuente ya no bloquean Eq337 |
