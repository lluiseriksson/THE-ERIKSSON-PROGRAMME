...
| Balaban CMP98 | Bibliografía y label/page map localizados; texto extraído y dos renders presentes, pero el path canónico `.pdf` es HTML Incapsula de 1157 bytes y Prop. 2 no está certificada visualmente | `located` | Registrar PDF primario limpio; verificar Prop. 2 y la ventana Q_k antes de alimentar `U_k` o `gaussian_pushforward` |
