...
| Balaban CMP98 | DOI oficial corregido y verificado como `10.1007/BF01211042`; el DOI anterior pertenecía a un artículo ajeno. Bibliografía y label/page map localizados; dos renders presentes, pero el path canónico `.pdf` es HTML Incapsula de 1157 bytes y Prop. 2 no está certificada visualmente | `located` | Registrar PDF primario limpio; verificar Prop. 2, las definiciones (52)–(53), la identidad (97), las cotas (102)–(103), (160)–(162) y Prop. 4 antes de alimentar la recursión analítica `Ubar`, `U_k` o `gaussian_pushforward` |
