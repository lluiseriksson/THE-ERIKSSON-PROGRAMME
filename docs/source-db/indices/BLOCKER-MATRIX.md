...
| 11 | `cmp102.variational-hessian-expansion-source-target` | `visual_confirmed` | Balaban CMP102 | Action expansion and positive second variation are located; still need the Wilson-Hessian coordinate/sign/normalization dictionary. |
