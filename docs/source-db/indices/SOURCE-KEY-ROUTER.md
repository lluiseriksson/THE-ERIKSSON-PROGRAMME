# Source Key Router — Batch 003

Use this when a citation key appears in a prompt or source-db search result and the agent needs to know which proof cards depend on it.
...
- Rank 1: `proof.eq231.membership-iff.source-package` — CMP116 Eq. (2.31) P-family source dictionary
  - Lean: `cmp116Eq231_balabanPFamily_sourcePIndexMemIff`, `cmp116Eq231PIndex_eq_sourceFilteredBondSets_of_mem_iff`, `CMP116Lemma3PStageSourceScaleBoundary.of_eq231_filteredBondSets`, `CMP116Lemma3WeightedPostPScaleSourceAssumptions.of_eq231_filteredBondSets`
- Rank 2: `proof.eq231.carrier-count.four-positive-directions` — CMP116 Eq. (2.31) eligible carrier cardinality
  - Lean: `CMP116Eq231PBondBoundary.of_sourceBondSets`, `CMP116Eq231PBondBoundary.of_sourceFilteredBondSets`, `cmp116Eq231GapCarrier_card_le_four_scale4_gapMass`
...
- Rank 3: `proof.eq231.pointwise-p-residual-majorization` — CMP116 Eq. (2.31) pointwise P-residual majorization
  - Lean: `cmp116PStageSourceBound_of_eq231_pointwise`, `CMP116Lemma3PStageSourceScaleBoundary.of_eq231_pointwise`, `CMP116Lemma3WeightedPostPScaleSourceAssumptions.of_eq231_boundaries`
...
- Rank 6: `proof.activity.termwise-identification` — CMP116 H(Z) activity identification and termwise estimate
  - Lean: `YangMills.RG.CMP116Lemma3ActivityTermwiseScaleBoundary`, `YangMills.RG.cmp116Lemma3ActivityEstimateScaleFamily_of_resummation`, `YangMills.RG.LocalActivity.globalEval`
...
- Rank 11: `proof.source-status-promotion.gates` — Quality gates for promoting a citation to source_extracted/theorem_checked
  - Lean: `source_db.verify`, `source_db.build`, `oracle_check.lean`
