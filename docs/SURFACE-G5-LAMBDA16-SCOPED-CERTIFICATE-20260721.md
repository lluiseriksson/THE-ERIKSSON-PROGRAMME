# Scoped G5 extension certificate: `lambda in [3/2,8/5]`

The previously isolated five-family extension has now been recorded as a
scoped certificate.  It covers the five registered delta bands for
...
`[79/50,8/5]`.  The manifest records the two transcript hashes, the
preregistration hash, and the validation scripts.

This certificate is deliberately scoped.  It does not modify the G5 gate
