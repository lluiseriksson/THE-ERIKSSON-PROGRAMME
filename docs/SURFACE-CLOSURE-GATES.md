...
The strict finite-beta relay audit currently reports 87 admissible manifested
units, eight beta gaps (including `[129/4,74]`), `promotion: NONE`, and
`relay_status: RELAY_LEMMA_UNPROVED`.  The candidate-topology audit reports
440 paired intervals with one remaining gap `[1629/16,1000/9]`; the three
