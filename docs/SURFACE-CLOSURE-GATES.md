...
The strict finite-beta relay audit currently reports 148 admissible manifested
units, eight beta gaps (including `[577/16,74]`), `promotion: NONE`, and
`relay_status: RELAY_LEMMA_UNPROVED`.  The candidate-topology audit reports
501 paired intervals with one remaining gap `[1629/16,1000/9]`; the three
