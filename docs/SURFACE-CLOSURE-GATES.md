...
`[333/4,86]` after nine preregistered repair units through `[83,333/4]`, so
the finite-beta relay remains open even though the candidate union has no gap.
