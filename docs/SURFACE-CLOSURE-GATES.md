...
`7ac09d96024fd7426a9e0f65bfdb598e636ddc9d` is superseded as a global seal.
The 2026-07-28 endpoint audit found that the full-moment Y assembler and its
error propagators applied `H0/K0=1/(8 cos(t/4))` twice.  G2's
`lambda>=3` lane therefore lost its load-bearing K2 evidence and G6 returned
to `BLOCKED`; see
`INCIDENT-DELTA0-Y-DOUBLE-NORMALIZATION-20260728.md`.
