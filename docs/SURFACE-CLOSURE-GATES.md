...
The strict finite-beta relay audit currently reports 273 admissible manifested
units, eight beta gaps (including `[701/16,69]`), `promotion: NONE`, and
`relay_status: RELAY_LEMMA_UNPROVED`.  The candidate-topology audit reports
626 paired intervals with one remaining gap `[1629/16,1000/9]`; the three
