...
|---|---|---|---|
| G0 | v88 numerical sanitation, T1--T7 | `RERUN_AUDIT_IN_PROGRESS` | independently rerun authoritative outputs, nonempty run manifests, reciprocal supersession, and green executable audit |
