...
**State:** `PREREGISTERED; QUARANTINED UNTIL COMPLETE`
...
```text
[193/4, 97/2], [97/2, 195/4], ..., [271/4,273/4], [273/4,275/4], [275/4,69]
```

Equivalently, the first endpoint is `193/4`, each interior step is `1/2`,
and the final endpoint is `69`; there are 42 units.  Every unit uses the
