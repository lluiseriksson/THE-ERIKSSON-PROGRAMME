"""Paired production/replay runner for the 300-bit rescue unit."""
...
DRIVER = ROOT / "scripts" / "certify_bulk_beta_taylor_scaled_sign_rows_cwin3p2_rescue300.py"
...
def main():
    ...
    tmp.replace(out)
    print("CWIN3P2 RESCUE300", args.unit,
