...
import launch_neumann_canonical_precision_promoted_cold as launch
import preserve_neumann_canonical_precision_cold as preserve
import verify_neumann_canonical_precision_promoted_cold as reader

assert launch.SOURCE == preserve.SOURCE == reader.SOURCE == '4746880218c694a9d4e9d32c0af61f86d460b7b4'
assert launch.REV == preserve.REV == reader.REV == 'neumann-canonical-precision-promoted-cold-v1'
...
nb=json.loads(Path('scripts/colab_neumann_canonical_precision_promoted_cold.ipynb').read_text())
...
ref='8ed60e286f2d670acfd0662ca21541fbedf20c29'
name='launch_neumann_canonical_precision_promoted_cold.py'
blob=subprocess.check_output(['git','cat-file','blob',ref+':scripts/'+name],timeout=5)
...
runpy.run_path('scripts/test_neumann_canonical_precision_cold_preparation.py',run_name='__main__')
print('CANONICAL_PRECISION_COLD_PACKAGE=PASS LAUNCHER_HASH=1 TRANSPORTS=4 CODE_CELLS=1')
