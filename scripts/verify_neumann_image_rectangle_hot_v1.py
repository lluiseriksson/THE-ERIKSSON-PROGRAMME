...
RUNNER_HASH = 'a72f26cd3e17108e7007c2e40cd5a3d363ef3e4af1b4b370f64fad78a0dc642c'
...
def verify(files):
    ...
    require(sha(repro) == 'cf6fbbb8dd4a8908aaac36bb66d012fe8974305afe913f9f9607ae8867f95076', 'REPRO_HASH')
