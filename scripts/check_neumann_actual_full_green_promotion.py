...
ITEMS = [('acc09ce87687c473f7fc8280e6d61c78e2d24f7e', 'NeumannActualFullGreenReflectionSummability', 3)]
...
manifest = 'tmp/neumann_actual_full_green_promotion_paths.txt'
...
print('ACTUAL_FULL_GREEN_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
