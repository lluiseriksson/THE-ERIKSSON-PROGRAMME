"""Validate order-24 extension-4 production/replay."""
...
BASES = [
    ROOT / "scripts" / "surface_scaled_bulk_mid_cover_64_257_4_129_2",
    ROOT / "scripts" / "surface_scaled_bulk_mid_cover_65_129_2_259_4",
]
...
def main() -> int:
    ...
    print("ORDER24 EXTENSION4 VALIDATION PASS", "UNITS", len(BASES), "ROWS", total)
