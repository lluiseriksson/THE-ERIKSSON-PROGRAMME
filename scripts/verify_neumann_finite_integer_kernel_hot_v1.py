...
SOURCE = '54dc3455fdf7b3e7949ed6f7b68f22ea995ad3b5'
BASE = '87edca6519df5b450b906e83db2ffa4fc1bd87bd'
REV = 'neumann-finite-integer-kernel-hot-v1'
ROOT = '/content/hrpoly-neumann-integer-image-promoted-cold-v1'
RUNNER_HASH = '44c5e43af8757b6c07d4703318fe45a616bafbc14203b9aac316b9d4b40d6ccc'
...
def verify(files):
    ...
    for s, path in [('mathlib_repro', 'tmp/NeumannFiniteIntegerCoordinatesMathlibRepro.lean'),
        ...
        require(r['command'] == ['lake', 'env', 'lean', '-o', '/content/' + REV + '-evidence/' + s + '.olean', path], 'COMMAND=' + s)
