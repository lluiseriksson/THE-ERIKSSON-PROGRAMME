#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for normalized directed CMP89 synthesis."""
...
spec = importlib.util.spec_from_file_location("cmp89_directed_normalized_integral_base", BASE_RUNNER)
...
EXPECTED = {
    306: {
        "YangMills.RG.cmp89Eq246DirectedNormalizedFullSolutionIntegral",
        "YangMills.RG.norm_cmp89Eq246DirectedNormalizedFullSolutionIntegral_le",
    },
}
...
runner.RUNNER_REV = "cmp89-eq246-directed-normalized-full-solution-integral-cold-v1"
runner.SOURCE_SHA = "887a726b4dc2d79925a67d16e9be4db935139e4d"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-directed-normalized-full-solution-integral-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-directed-normalized-full-solution-integral-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-directed-normalized-full-solution-integral-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-directed-normalized-full-solution-integral-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
...
runner.QUEUE = [
    (
        ...
        ["lake", "build", "YangMills.RG.BalabanCMP89Eq246DirectedNormalizedFullSolutionIntegral"],
        None,
    ),
    (
        "directed_normalized_full_solution_integral_audit",
        ["lake", "env", "lean", "YangMills/RG/BalabanCMP89Eq246DirectedNormalizedFullSolutionIntegralAudit.lean"],
        306,
    ),
]
