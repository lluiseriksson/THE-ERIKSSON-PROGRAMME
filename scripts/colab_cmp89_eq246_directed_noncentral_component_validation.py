#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for the directed CMP89 noncentral component."""
...
spec = importlib.util.spec_from_file_location("cmp89_directed_noncentral_base", BASE_RUNNER)
...
EXPECTED = {
    303: {
        "YangMills.RG.norm_inv_cmp89Eq246EntireAliasFineSymbol_le_halfWeight",
        "YangMills.RG.norm_cmp89Eq246TargetPhase_mul_bareDiagonal_signedContour_le",
        "YangMills.RG.norm_cmp89Eq246TargetPhase_mul_noncentralCorrection_signedContour_le",
        "YangMills.RG.norm_cmp89Eq246TargetPhase_mul_noncentralSolution_signedContour_le",
    },
}
...
runner.RUNNER_REV = "cmp89-eq246-directed-noncentral-component-cold-v1"
runner.SOURCE_SHA = "b90a58ddc8893f081ffccb1b6ad8409226075972"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-directed-noncentral-component-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-directed-noncentral-component-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-directed-noncentral-component-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-directed-noncentral-component-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
...
runner.QUEUE = [
    (
        ...
        ["lake", "build", "YangMills.RG.BalabanCMP89Eq246DirectedNoncentralComponent"],
        None,
    ),
    (
        "directed_noncentral_component_audit",
        ["lake", "env", "lean", "YangMills/RG/BalabanCMP89Eq246DirectedNoncentralComponentAudit.lean"],
        303,
    ),
]
