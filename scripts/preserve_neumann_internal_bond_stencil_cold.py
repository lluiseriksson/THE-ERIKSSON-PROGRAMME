...
LAUNCHER = 'launch_neumann_internal_bond_stencil_promoted_cold.py'
LAUNCHER_HASH = 'd7620dfeb9545a659e35f1b2390fcc9967fe12600ef8613b0998ec7ee3a405e6'
SCOPE = "actual Neumann internal-bond adjoint and finite divergence only; not reflected Green boundary law, regional inverse, uniform B0 or window15"
PINS = {
    'colab_neumann_internal_bond_stencil_promoted_cold.py': ('2b641e2ba98a78e2390252791c0a503778d33e67', '15b6ec93051d138a1d2ee3197bb1cd4143ee18cdd3c542c901486800655ee43a'),
    'verify_neumann_internal_bond_stencil_promoted_cold.py': ('2b641e2ba98a78e2390252791c0a503778d33e67', '0c05cae2596a96c7fac5ff334da996b53ef153a06bdae4eaa68d368ffce55729'),
...
def verify_scope(files):
    contract = json.loads(files['neumann-internal-bond-stencil-promoted-cold-contract.json'])
...
def main():
    ...
    verifier = work + 'verify_neumann_internal_bond_stencil_promoted_cold.py'
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_internal_bond_stencil_promoted_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_internal_bond_stencil_promoted_cold.py'], 'verify_neumann_internal_bond_stencil_promoted_cold.py')
    ...
    print('NEUMANN_INTERNAL_BOND_STENCIL_COLD_PRESERVED COMPILER_SEAL=1')
