...
ITEMS = [('852d3b82ed5d0ffd2e5c38eb4eeb96c433858bbc', 'NeumannCanonicalSpacingNormalization', 3)]
...
manifest = 'tmp/neumann_canonical_spacing_promotion_paths.txt'
...
print('CANONICAL_SPACING_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
