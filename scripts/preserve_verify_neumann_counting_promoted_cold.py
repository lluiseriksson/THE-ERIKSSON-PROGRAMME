...
LAUNCHER = 'launch_neumann_counting_promoted_cold.py'
LAUNCHER_HASH = '6f124ac7c43e7f3fa247123db0420b2c903c7e9161ac6a06fcf670d3ef5d69d9'
PINS = {
    'colab_neumann_counting_promoted_cold.py': ('2ef47fc11740a21c4c495fc8d80e0216fdce3887', '87aafa61ce1824a5b8fc4acf4cd107944b52e9531d2fb37bebaa3dde99d9033f'),
    'verify_neumann_counting_promoted_cold.py': ('2ef47fc11740a21c4c495fc8d80e0216fdce3887', '9decd5ede386cf72c30c6a1909e545f852a68e8fad4801ba48674adbe0caf5c5'),
...
def main():
    ...
    verifier = work + 'verify_neumann_counting_promoted_cold.py'
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_counting_promoted_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_counting_promoted_cold.py'], 'verify_neumann_counting_promoted_cold.py')
    ...
    result = dict(status='PASS', source=SOURCE, outer_sha256=sha(blob),
        ...
        scope='intermediate counting reflection and retained terminal mass; not regional inverse or window15')
    ...
    print('NEUMANN_COUNTING_PROMOTED_COLD_PRESERVATION=PASS')
