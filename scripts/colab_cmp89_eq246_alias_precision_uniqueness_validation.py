#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for CMP89 finite alias-precision uniqueness."""
...
spec = importlib.util.spec_from_file_location("cmp89_alias_precision_uniqueness_base", BASE_RUNNER)
...
runner.RUNNER_REV = "cmp89-eq246-alias-precision-uniqueness-cold-v1"
runner.SOURCE_SHA = "23be18e4fa7628ff553c9dc7d80d9a6dc5462c98"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-eq246-alias-precision-uniqueness-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-eq246-alias-precision-uniqueness-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-eq246-alias-precision-uniqueness-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-eq246-alias-precision-uniqueness-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
