...
rb = subprocess.check_output(['git', 'cat-file', 'blob', '7eea0b2396a24c3213680a1122f8e4e5f84861d9:scripts/colab_neumann_canonical_precision_offsets_hot_v1.py'], timeout=5)
rt = rb.decode()
vt = Path('scripts/verify_neumann_canonical_precision_offsets_hot_v1.py').read_text()
