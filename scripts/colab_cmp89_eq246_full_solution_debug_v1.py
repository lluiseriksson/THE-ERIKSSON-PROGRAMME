#!/usr/bin/env python3
"""Retained-runtime diagnostic for the full CMP89 (2.46) alias solution."""
...
runner.RUNNER_REV = "cmp89-eq246-full-solution-debug-v1"
runner.SOURCE_SHA = "3ff1731cd3c936612b3f2a4acb0c543a748159b4"
runner.ROOT = Path("/content/hrpoly-cmp89-eq246-full-solution-debug-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-eq246-full-solution-debug-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-eq246-full-solution-debug-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-eq246-full-solution-debug-v1-paths.txt")
runner.SOURCE_BLOBS = {
    "YangMills/RG/BalabanCMP89Eq246StabilizedAliasFullSolution.lean":
        "1040732433d3a1453f3a3656f37c063fc359b1bf2c33ac6607ba2f1c6a771a8d",
