...
LAUNCHER = 'launch_neumann_integer_dictionary_cohort_cold.py'
LAUNCHER_HASH = '0262e3875378a1e5b8a5e5c0915b9346a289ef3a235db751583ef35aba52dfb3'
PINS = {
    'colab_neumann_integer_dictionary_cohort_cold.py': ('f75e276b5ede406e15fcda9a0a7e2f834975decf', '8215ef629fbe3f064d8a5ac8ab45dae2365d2cc4601b5f2728dc90ff09edfb12'),
    'verify_neumann_integer_dictionary_cohort_cold.py': ('f75e276b5ede406e15fcda9a0a7e2f834975decf', 'bf44b61d7659ceabacfc42cc301a74829c69a9f7cc8fbf49553710b57633b59e'),
...
def main():
    ...
    verifier = work + 'verify_neumann_integer_dictionary_cohort_cold.py'
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_integer_dictionary_cohort_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_integer_dictionary_cohort_cold.py'], 'verify_neumann_integer_dictionary_cohort_cold.py')
    ...
    result = dict(status='PASS', source=SOURCE, outer_sha256=sha(blob),
        ...
        scope='finite physical counting-owner and full 1D image-family bijection; not inverse, B0 or window15')
    ...
    print('NEUMANN_INTEGER_DICTIONARY_COHORT_COLD_PRESERVATION=PASS')
