#!/usr/bin/env python3
"""Bounded HOT diagnostic, after FULL evidence preservation; never a cold seal."""
...
ROOT = Path('/content/hrpoly-neumann-physical-full-flag-diagnostic-v1')
...
OUT = Path('/content/neumann-physical-mixed-summability-hot-v1')
...
def main():
    ...
    if not Path('/content/full-flag-evidence-preserved.ok').is_file():
