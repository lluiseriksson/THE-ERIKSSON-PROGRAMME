...
import launch_neumann_internal_bond_stencil_promoted_cold as launch
import preserve_neumann_internal_bond_stencil_cold as preserve
import verify_neumann_internal_bond_stencil_promoted_cold as reader

assert launch.SOURCE == preserve.SOURCE == reader.SOURCE == '81f35765ad50f8217bca20bc4530d99b3bf05103'
assert launch.REV == preserve.REV == reader.REV == 'neumann-internal-bond-stencil-promoted-cold-v1'
...
nb=json.loads(Path('scripts/colab_neumann_internal_bond_stencil_promoted_cold.ipynb').read_text())
...
ref='8111de7b896885565fdc6327e5c039b5acb7985e'
name='launch_neumann_internal_bond_stencil_promoted_cold.py'
blob=subprocess.check_output(['git','cat-file','blob',ref+':scripts/'+name],timeout=5)
...
runpy.run_path('scripts/test_neumann_internal_bond_stencil_cold_preparation.py',run_name='__main__')
print('INTERNAL_BOND_STENCIL_COLD_PACKAGE=PASS LAUNCHER_HASH=1 TRANSPORTS=4 CODE_CELLS=1')
