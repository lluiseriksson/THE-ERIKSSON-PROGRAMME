...
ITEMS = [('b7ac45acae587b0175526006f5a8d9a4247dea7c', 'NeumannGeneratedCompleteFibre', 6)]
...
manifest = 'tmp/neumann_complete_fibre_promotion_paths.txt'
...
print('COMPLETE_FIBRE_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
