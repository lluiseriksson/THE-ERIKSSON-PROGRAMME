#!/usr/bin/env python3
"""Read-only source-flow full-G F2/F3 evidence verifier. No Lean, Git or subprocess calls.
...
REV = 'cmp99-source-flow-full-green-owner-v1'
...
NAMES = {
    'generic_residue_audit': {'cmp99SourceFlatFullPointSourceSolution_eq_scaledOwnerResidue'},
    'source_owner_audit': {
...
COMMANDS = {
    'generic_residue_focal': ['lake', 'build', 'YangMills.RG.BalabanCMP99SourceFlatFullPointSourceOwnerResidueIdentity'],
    'generic_residue_audit': ['lake', 'env', 'lean', 'YangMills/RG/BalabanCMP99SourceFlatFullPointSourceOwnerResidueIdentityAudit.lean'],
    'source_owner_focal': ['lake', 'build', 'YangMills.RG.BalabanCMP99SourceFlowFullPointSourceOwnerBound'],
    'source_owner_audit': ['lake', 'env', 'lean', 'YangMills/RG/BalabanCMP99SourceFlowFullPointSourceOwnerBoundAudit.lean'],
}
...
def self_test(gate, old):
    ...
    print('SOURCE_FLOW_OWNER_VERIFIER_SELF_TEST=PASS synthetic=1 rejected=' + str(len(bads)))
...
def main():
    ...
    print('SOURCE_FLOW_OWNER_COLD_EVIDENCE_VERIFIED')
