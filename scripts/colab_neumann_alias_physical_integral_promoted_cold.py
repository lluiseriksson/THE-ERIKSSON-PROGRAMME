...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-alias-physical-integral-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("integral_focal", ["lake","build","YangMills.RG.NeumannAliasPhysicalIntegral"], None),
        ("integral_audit", ["lake","env","lean","YangMills/RG/NeumannAliasPhysicalIntegralAudit.lean"], audit_names["integral_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-alias-physical-integral-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
            ...
            'scope': "literal normalized finite alias integral with explicit N^4; not physical inverse, density/counting transport, uniform B0 or window15",
        }, sort_keys=True) + '\n', encoding='utf-8')
        outputs = {}
