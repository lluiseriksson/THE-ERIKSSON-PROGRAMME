...
rb = subprocess.check_output(['git', 'cat-file', 'blob', 'f5e55dd1ed1e4fb751116997cb0feb7d54d3936c:scripts/colab_neumann_canonical_precision_offsets_hot_v3.py'], timeout=5)
rt = rb.decode()
vt = Path('scripts/verify_neumann_canonical_precision_offsets_hot_v3.py').read_text()
