"""Bounded branch-packaging HOT diagnostic after verified fixed-source cold parent. Never a cold seal."""
...
ROOT=Path('/content/hrpoly-neumann-mixed-fixed-source-promoted-cold-v1')
OUT=Path('/content/neumann-mixed-branch-packaging-hot-v2')
PINS={
 'tmp/NeumannBranchReductionRepro.lean':'47035eaf725b435d8f61eeb1a005a1c3ccfac35b17fea98a30237ecb39a725d5',
 'tmp/NeumannMixedBranchPackagingDraft.lean':'368f4dd6846be067b703ab1d34b34a120ed3fee6cb846e7c66c9329160366be2',
 'scripts/verify_neumann_mixed_fixed_source_promoted_cold.py':'eca06e8ff273c26a5abad0e8ebe8e64cadd88a00d3b8e339548c3520298dd97c',
...
NAMES=set(["neumannMixedBranchCode_injective","neumannMixedBranchFamily_card_le","neumannMixedBranchFamily_card_le_sixteen","neumannMixedFixedCoordinatePack","neumannMixedGlobalFixedIndexEquiv","neumannMixedGlobalFixedIndexEquiv_apply","neumannMixedGlobalFixedSource_injective"])
...
def main():
 ...
 try:
  ...
  run('parent_verify',[sys.executable,str(OUT/'verify_neumann_mixed_fixed_source_promoted_cold.py'),'--helpers',str(OUT),'--archive',str(ROOT)+'-evidence.tar.gz','--sha256',args.parent_sha256])
  ...
  draft=(OUT/'NeumannMixedBranchPackagingDraft.lean').read_text()
  expected={'YangMills.RG.'+n for n in NAMES}
  audits={}
  audits['repro']=exact_axioms(run('repro',['lake','env','lean',str(OUT/'NeumannBranchReductionRepro.lean')],60),{'branchRepro_unique'})
  audits['mixed']=exact_axioms(run('mixed',['lake','env','lean','--root='+str(OUT),'-o',str(OUT/'mixed.olean'),str(OUT/'NeumannMixedBranchPackagingDraft.lean')]),expected)
