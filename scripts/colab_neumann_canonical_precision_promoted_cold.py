#!/usr/bin/env python3
"""Fresh cold gate for the two canonical Neumann finite-action declarations.
...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-canonical-precision-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("canonical_precision_focal", ["lake", "build", "YangMills.RG.NeumannCanonicalPrecisionOffsetAction"], None),
        ("canonical_precision_audit", ["lake", "env", "lean", "YangMills/RG/NeumannCanonicalPrecisionOffsetActionAudit.lean"], audit_names["canonical_precision_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-canonical-precision-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
