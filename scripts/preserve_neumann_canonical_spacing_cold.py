...
LAUNCHER = 'launch_neumann_canonical_spacing_promoted_cold.py'
LAUNCHER_HASH = 'c183117cf3277f8e4ff88a75bc0e86ac73af0267c8a4920baef4978a3bcdbbc6'
...
PINS = {
    'colab_neumann_canonical_spacing_promoted_cold.py': ('e2693781db75058bd69d74fa659b17da2f89d6f0', 'dc92529f0d7f10a076c939f32462872cd3a362abc0c057b299e1386a35b06c9f'),
    'verify_neumann_canonical_spacing_promoted_cold.py': ('e2693781db75058bd69d74fa659b17da2f89d6f0', '50ed7d38dc3695a48eb1e709f0b10f5ac14a9ec3c60f526f1c89c7ae4805ca94'),
...
def verify_scope(files):
    contract = json.loads(files['neumann-canonical-spacing-promoted-cold-contract.json'])
...
def main():
    ...
    verifier = work + 'verify_neumann_canonical_spacing_promoted_cold.py'
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_canonical_spacing_promoted_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_canonical_spacing_promoted_cold.py'], 'verify_neumann_canonical_spacing_promoted_cold.py')
    ...
    print('NEUMANN_CANONICAL_SPACING_COLD_PRESERVED COMPILER_SEAL=1')
