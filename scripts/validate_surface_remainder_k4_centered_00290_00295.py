...
UNIT = "k4_00290_00295"
BAND = (Fraction(29, 1000), Fraction(59, 2000), 9216)
DEPS = (
    "scripts/certify_surface_remainder_k4_centered_band.py",
    "scripts/certify_surface_remainder_k4_centered_00290_00295.py",
...
def parse(path: Path) -> tuple[list[str], int]:
    ...
    assert f"CONFIG unit {UNIT} delta 29/1000:59/2000 " in lines[5]
