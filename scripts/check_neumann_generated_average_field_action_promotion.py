...
ITEMS = [('765c7be79997313ebc6f72244d617634a4192700', 'NeumannGeneratedAverageFieldAction', 3)]
...
manifest = 'tmp/neumann_generated_average_field_action_promotion_paths.txt'
...
print('FIELD_ACTION_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
