#!/usr/bin/env python3
"""Exact seven-name branch-packaging cold reader. Independent contract and output checks. No Lean, Git or subprocess calls.
...
SOURCE = 'c9818c183643a19b0cb88d614ea7b10ad3e8eda6'
REV = 'neumann-mixed-branch-packaging-promoted-cold-v1'
...
BLOBS = {
    "YangMills/RG/NeumannMixedBranchPackaging.lean": "59e3a9b65ce551d3f1fc2c3d8f50c036bf6901c19d0f974ba0792ca72ca91377",
    "YangMills/RG/NeumannMixedBranchPackagingAudit.lean": "8d052d9770051ad58cdaa04effc9bc7ae90bc959567a68d907d999b0729998d8"
}
NAMES = {
    "branch_audit": [
        "YangMills.RG.neumannMixedBranchCode_injective",
        "YangMills.RG.neumannMixedBranchFamily_card_le",
        "YangMills.RG.neumannMixedBranchFamily_card_le_sixteen",
        "YangMills.RG.neumannMixedFixedCoordinatePack",
        "YangMills.RG.neumannMixedGlobalFixedIndexEquiv",
        "YangMills.RG.neumannMixedGlobalFixedIndexEquiv_apply",
        "YangMills.RG.neumannMixedGlobalFixedSource_injective"
    ]
}
...
COMMANDS = {
    "branch_focal": [
        "lake",
        "build",
        "YangMills.RG.NeumannMixedBranchPackaging"
    ],
    "branch_audit": [
        "lake",
        "env",
...
def verify(files, gate, old):
    ...
    require(contract.get('source_sha') == SOURCE and
            ...
            'GATE_CONTRACT')
    owner = json.loads(files['neumann-mixed-branch-packaging-promoted-cold-contract.json'])
    expected_owner = dict(source_sha=SOURCE,
            parent_diagnostics=[{"source":"476cc52e0b672438a2e6e23d21e2769c2db9cdef","archive_sha256":"940cfa9103d51e2ecee273e71abd62fec1326496f8103bdf452262d36b4ce542"}],
        project_build_cache_restored=False,
            ...
            queue=list(COMMANDS), scope="exact global fixed-source index packaging and at-most16 branches in 4D; not physical carrier classification, physical inverse, uniform B0 or window15", parser_self_test={'accepted': 2, 'rejected': 9})
    ...
    expected_files = {'evidence.json', 'gate-contract.json', 'neumann-mixed-branch-packaging-promoted-cold-contract.json', 'preflight.json'}
    indexed = {}
    for r in records:
        stage = r['stage']
        indexed[stage] = r
    ...
    require(set(production) == set(["NeumannMixedBranchPackaging.olean"]), 'PRODUCTION_OUTPUT_SET')
...
def self_test(gate, old):
    ...
    files['neumann-mixed-branch-packaging-promoted-cold-contract.json'] = json.dumps(dict(source_sha=SOURCE,
        parent_diagnostics=[{"source":"476cc52e0b672438a2e6e23d21e2769c2db9cdef","archive_sha256":"940cfa9103d51e2ecee273e71abd62fec1326496f8103bdf452262d36b4ce542"}],
        project_build_cache_restored=False,
        durable_base_commit='ddf6fdc1882edddbf063389aab4d455a8ed30801',
        durable_base_sha256=WRAPPER_HASH, axiom_gate_sha256=GATE_HASH,
        audit_expected={s: sorted(n) for s,n in NAMES.items()}, queue=list(COMMANDS),
        scope="exact global fixed-source index packaging and at-most16 branches in 4D; not physical carrier classification, physical inverse, uniform B0 or window15", parser_self_test={'accepted':2,'rejected':9})).encode()
    production = {}
    for name in ["NeumannMixedBranchPackaging.olean"]:
    ...
    print('NEUMANN_MIXED_BRANCH_PACKAGING_VERIFIER_SELF_TEST=PASS synthetic=1 rejected=' + str(len(bads)))
...
def main():
    ...
    print('NEUMANN_MIXED_BRANCH_PACKAGING_COLD_EVIDENCE_VERIFIED')
