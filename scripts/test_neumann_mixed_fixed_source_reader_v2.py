...
import verify_neumann_mixed_fixed_source_hot_v2 as v
...
runner='35a1f574a2ba662ce251ae29e9a7565ffb576a72:scripts/colab_neumann_mixed_fixed_source_hot_v2.py'
...
for s,c in cmds.items():
 ...
 if s=='parent_verify':text='{}\nNEUMANN_MIXED_COORDINATE_COLD_EVIDENCE_VERIFIED\n'
 if s in v.NAMES:
