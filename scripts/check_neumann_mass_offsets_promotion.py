...
ITEMS = [('6d02bcfd4091fb549dd9856f6fa95bb10e854643', 'NeumannGeneratedMassCompleteOffsets', 6)]
...
manifest = 'tmp/neumann_mass_offsets_promotion_paths.txt'
...
print('MASS_OFFSETS_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
