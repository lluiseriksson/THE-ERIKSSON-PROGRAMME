"""One-shot launcher for the eleven-name physical dictionary intermediate cold gate.
...
WORK = Path('/content/neumann-integer-dictionary-cohort-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-integer-dictionary-cohort-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_integer_dictionary_cohort_cold.py': (
        'f75e276b5ede406e15fcda9a0a7e2f834975decf',
        '8215ef629fbe3f064d8a5ac8ab45dae2365d2cc4601b5f2728dc90ff09edfb12'),
    'verify_neumann_integer_dictionary_cohort_cold.py': (
        'f75e276b5ede406e15fcda9a0a7e2f834975decf',
        'bf44b61d7659ceabacfc42cc301a74829c69a9f7cc8fbf49553710b57633b59e'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_integer_dictionary_cohort_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_integer_dictionary_cohort_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_integer_dictionary_cohort_cold.py')
