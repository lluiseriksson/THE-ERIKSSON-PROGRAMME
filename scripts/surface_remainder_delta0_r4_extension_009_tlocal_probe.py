"""Pre-registered t-local-band witness at the first open K2 boundary."""
...
import surface_remainder_delta0_tlocal_band_design as local_band
...
def judge():
    ...
    radius, bands = local_band.direct_moving_band_value_coefficients_from(
...
def main():
    ctx.prec = 140
    print("R4 009 T-LOCAL-BAND WITNESS", "delta_max", DELTA_MAX,
