...
REV = 'neumann-selector-opposite-promoted-cold-v1'
...
COMMANDS = {
    "selector_focal": [
        "lake",
        "build",
        "YangMills.RG.NeumannAliasExponentialSelector"
    ],
    "selector_audit": [
        "lake",
        "env",
        "lean",
        "YangMills/RG/NeumannAliasExponentialSelectorAudit.lean"
    ],
    "opposite_focal": [
        "lake",
        "build",
        "YangMills.RG.NeumannOppositeDifference"
    ],
    "opposite_audit": [
        "lake",
        "env",
        "lean",
        "YangMills/RG/NeumannOppositeDifferenceAudit.lean"
    ]
}
...
def verify(files, gate, old):
    ...
    require(contract.get('source_sha') == SOURCE and
            ...
            'GATE_CONTRACT')
    owner = json.loads(files['neumann-selector-opposite-promoted-cold-contract.json'])
    expected_owner = dict(source_sha=SOURCE,
        ...
        project_build_cache_restored=False,
            ...
            queue=list(COMMANDS), scope="finite alias exponential congruence selector and scalar opposite differences; not physical source equation, counting inverse, uniform B0 or window15", parser_self_test={'accepted': 2, 'rejected': 9})
    ...
    expected_files = {'evidence.json', 'gate-contract.json', 'neumann-selector-opposite-promoted-cold-contract.json', 'preflight.json'}
    indexed = {}
    for r in records:
        stage = r['stage']
        indexed[stage] = r
    ...
    require(set(production) == set(["NeumannAliasExponentialSelector.olean","NeumannOppositeDifference.olean"]), 'PRODUCTION_OUTPUT_SET')
...
def self_test(gate, old):
    ...
    files['neumann-selector-opposite-promoted-cold-contract.json'] = json.dumps(dict(source_sha=SOURCE,
        parent_diagnostics=[{"source":"0dcd87f8b60dfb464fb3a6707b8f65fe96637960","archive_sha256":"8b72d4250c6a2b8737dbbee6c719e647b7dd0377bc9174f48f9bbaad753c6d2c","source_blobs":{"tmp/NeumannAliasExponentialSelectorDraft.lean":"48777e553acc6f908a78bc3de7f04ad42068fd1d53a56a60f41449e2f15d2e01"}},{"source":"b3ca1ca8f749517014c934ff956116ecab19210d","archive_sha256":"026b3918979f14f7d3ca4f6e28135358e3ec58d76c1e7885973b0c32047972cb","source_blobs":{"tmp/NeumannOppositeDifferenceRepro.lean":"f0f97dee3b98e0410c69969d40aed56c45a2cc4be8d17db9c967d18d3d569864"}}],
        project_build_cache_restored=False,
        durable_base_commit='ddf6fdc1882edddbf063389aab4d455a8ed30801',
        durable_base_sha256=WRAPPER_HASH, axiom_gate_sha256=GATE_HASH,
        audit_expected={s: sorted(n) for s,n in NAMES.items()}, queue=list(COMMANDS),
        scope="finite alias exponential congruence selector and scalar opposite differences; not physical source equation, counting inverse, uniform B0 or window15", parser_self_test={'accepted':2,'rejected':9})).encode()
    production = {}
