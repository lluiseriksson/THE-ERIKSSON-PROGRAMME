...
BLOBS = {
    ...
    'tmp/NeumannGeneratedCountingMassReflectionDraft.lean': '2cd7378c983dfb2f08da54fe4d3c9ce333b0a630f05630c52bf52e66586e3aed',
}
NAMES = {
...
def main():
    ...
    launch = json.loads(outer[prefix + 'launch-final-status.json'])
