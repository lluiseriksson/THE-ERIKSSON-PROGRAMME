"""One-shot launcher for the four-name Neumann directional rectangle masks intermediate cold gate.
...
WORK = Path('/content/neumann-directional-masks-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-directional-masks-promoted-cold-v1-preservation-20260907.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_directional_masks_promoted_cold.py': (
        '4ea6a13bca3e7466f80da72757542cdfd31ade79',
        '4a813825c2e3cf7facdc25325a86acee93762337eb35c149cde1eafb61079675'),
    'verify_neumann_directional_masks_promoted_cold.py': (
        '4ea6a13bca3e7466f80da72757542cdfd31ade79',
        '1076bcbe55e57d6d6bd09ae18041f13ad1b783e89d254f3fafb16cd86d11a3e1'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_directional_masks_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_directional_masks_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_directional_masks_promoted_cold.py')
