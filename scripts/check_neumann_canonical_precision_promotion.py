...
ITEMS = [('8aa5fe1ff3d166ad67debbda3aa4a23ff659950c', 'NeumannCanonicalPrecisionOffsetAction', 2)]
...
manifest = 'tmp/neumann_canonical_precision_promotion_paths.txt'
...
print('CANONICAL_PRECISION_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
