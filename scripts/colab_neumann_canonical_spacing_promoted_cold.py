#!/usr/bin/env python3
"""Fresh cold gate for the three canonical spacing normalization declarations.
...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-canonical-spacing-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("canonical_spacing_focal", ["lake", "build", "YangMills.RG.NeumannCanonicalSpacingNormalization"], None),
        ("canonical_spacing_audit", ["lake", "env", "lean", "YangMills/RG/NeumannCanonicalSpacingNormalizationAudit.lean"], audit_names["canonical_spacing_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-canonical-spacing-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
