"""Validator for the pre-registered lower K4 centred-band pair."""
...
UNIT = "k4_00295_0030"
BAND = (Fraction(59, 2000), Fraction(3, 100), 9216)
DEPS = (
    "scripts/certify_surface_remainder_k4_centered_band.py",
    "scripts/certify_surface_remainder_k4_centered_00295_0030.py",
...
def parse(path: Path) -> tuple[list[str], int]:
    ...
    assert f"CONFIG unit {UNIT} delta 59/2000:3/100 " in lines[5]
