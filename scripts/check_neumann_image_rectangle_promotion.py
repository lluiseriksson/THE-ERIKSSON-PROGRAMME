...
ITEMS = [('fbf2e61f38afbe050200a0c7aa275b46ae45a924', 'NeumannImageRectangleCoverage', 5)]
...
manifest = 'tmp/neumann_image_rectangle_promotion_paths.txt'
...
print('RECTANGLE_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
