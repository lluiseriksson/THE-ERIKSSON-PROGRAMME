...
from verify_neumann_generated_average_field_action_hot_v1 import verify, RUNNER_HASH
p = 'scripts/colab_neumann_generated_average_field_action_hot_v1.py'
b = subprocess.check_output(['git','cat-file','blob','85ad19f6b1e941012b17c8f432fff4bfff7a3f5e:'+p],timeout=5)
...
print('FIELD_ACTION_INSTRUMENTS=PASS inputs=3 names=3 old_archive_rejected=1 NO_COMPILER_EVIDENCE')
