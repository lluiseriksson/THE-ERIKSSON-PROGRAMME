"""Exhaustive design cover for delta<=0.007 with physical split 23/20."""
...
def main():
    ...
    worst = None
    print("R4 007 SPLIT COVER DESIGN", "boxes", len(boxes),
    ...
    for index in range(args.start_index, stop):
        ...
        for grid in GRID_LADDER:
            ...
            if lower > 0:
                ...
                break
        if passed is None:
            print("R4 007 SPLIT COVER DESIGN FAIL", index, flush=True)
            return 1
    ...
    print("R4 007 SPLIT COVER DESIGN SEGMENT PASS", args.start_index, stop,
