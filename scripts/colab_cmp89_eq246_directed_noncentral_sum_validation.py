#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for the directed CMP89 noncentral alias sum."""
...
spec = importlib.util.spec_from_file_location("cmp89_directed_noncentral_sum_base", BASE_RUNNER)
...
EXPECTED = {
    304: {
        "YangMills.RG.cmp89Eq246DirectedNoncentralSolutionSum",
        "YangMills.RG.cmp89Eq246DirectedNoncentralSolutionSumBound",
        "YangMills.RG.norm_cmp89Eq246DirectedNoncentralSolutionSum_signedContour_le",
    },
}
...
runner.RUNNER_REV = "cmp89-eq246-directed-noncentral-sum-cold-v1"
runner.SOURCE_SHA = "1f3bc9b0bb85016d1ebb96514b4da54f5e32b754"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-directed-noncentral-sum-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-directed-noncentral-sum-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-directed-noncentral-sum-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-directed-noncentral-sum-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
...
runner.QUEUE = [
    (
        ...
        ["lake", "build", "YangMills.RG.BalabanCMP89Eq246DirectedNoncentralSum"],
        None,
    ),
    (
        "directed_noncentral_sum_audit",
        ["lake", "env", "lean", "YangMills/RG/BalabanCMP89Eq246DirectedNoncentralSumAudit.lean"],
        304,
    ),
]
