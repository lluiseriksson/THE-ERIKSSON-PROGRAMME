#!/usr/bin/env python3
"""Fresh-checkout cold gate for the CMP89 (2.46) one-coordinate contour shift."""
...
spec = importlib.util.spec_from_file_location("cmp89_integrand_shift_base", BASE_RUNNER)
...
EXPECTED = {
    316: {
        "YangMills.RG.intervalIntegral_cmp89Eq246PhysicalFineToFineGreenIntegrand_coordinateShift",
    },
}
...
runner.RUNNER_REV = "cmp89-eq246-integrand-one-coordinate-shift-cold-v1"
runner.SOURCE_SHA = "881a6de1c6c945161c65f9d9966319b17e386e4c"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-eq246-integrand-one-coordinate-shift-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-eq246-integrand-one-coordinate-shift-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-eq246-integrand-one-coordinate-shift-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-eq246-integrand-one-coordinate-shift-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
...
runner.QUEUE = [
    (
        ...
        ["lake", "build", "YangMills.RG.BalabanCMP89Eq246FineToFineGreenOneCoordinateContourShift"],
        None,
    ),
    (
        "integrand_one_coordinate_shift_audit",
        ["lake", "env", "lean", "YangMills/RG/BalabanCMP89Eq246FineToFineGreenOneCoordinateContourShiftAudit.lean"],
        316,
    ),
]
