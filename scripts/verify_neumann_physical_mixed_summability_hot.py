...
BASE = 'f0c58431d20042ced9177632409e9f9bcbe79692'
SOURCE = 'bee3c451b41b5da2a1d876d7ad3f0de27a17bdee'
DRAFT = 'tmp/NeumannPhysicalMixedSummabilityDraft.lean'
DIGEST = 'b2a338a4b7f682dcfb68dc616e9f3a4e8749239fd9021c77e3847fa0737c8da8'
RUNNER = '43a7113220eb3cdb6706793090a4c27e92b8be6cf12d9465bf24d402935c1fd2'
GATE = '016ca4daf0cd06c8016ece106334cc10a4c332c0a58f7f383f03c6f6b3e287c2'
PREFIX = 'neumann-physical-mixed-summability-hot-v1'
ROOT = '/content/hrpoly-neumann-physical-full-flag-diagnostic-v1'
NAMES = {'YangMills.RG.' + n for n in [
    'neumannMixedSourceDifference_injective',
    'summable_neumannMixedSource_of_decay',
    'summable_neumannActualFullGreen_mixedSource']}
COMMANDS = {
    'prerequisites': ['lake', 'build', 'YangMills.RG.NeumannMixedOwnerTransport',
                     'YangMills.RG.NeumannPhysicalPeriodicSummability'],
    'mixed_summability': ['lake', 'env', 'lean', DRAFT]}
...
def verify(files, gate):
    expected = {'runner.py', 'source.lean', 'result.json', 'manifest.json',
                'prerequisites.log', 'mixed_summability.log'}
    ...
    audits = gate.exact_axioms(files['mixed_summability.log'].decode(), NAMES)
...
def main():
    ...
    print('MIXED_SUMMABILITY_HOT_EVIDENCE_VERIFIED_NOT_COLD')
