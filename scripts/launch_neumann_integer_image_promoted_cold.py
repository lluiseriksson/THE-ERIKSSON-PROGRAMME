"""One-shot launcher for the seven-name integer image-owner intermediate cold gate.
...
WORK = Path('/content/neumann-integer-image-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-integer-image-promoted-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_integer_image_promoted_cold.py': (
        '8564dbfee39468e7a6d50e52e4173c0da844d315',
        '9f2ea3bcb492125c7e20d8ceb761128421baedb7695e9b56b97d2ffe4b9317ec'),
    'verify_neumann_integer_image_promoted_cold.py': (
        '8564dbfee39468e7a6d50e52e4173c0da844d315',
        'b505adb82b52eb7bb3abf3dc8874bb291aee5e2b9c5d9c687b392878430ac957'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_integer_image_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_integer_image_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_integer_image_promoted_cold.py')
