"""Verify and preserve exact directional Neumann masks cold PASS; rejects partial/failing evidence."""
import argparse
import json
import math
...
LAUNCHER = 'launch_neumann_directional_masks_promoted_cold.py'
LAUNCHER_HASH = 'b469f7e30207d7e3a5f29712c27917d6b5bf55b6f640938015da52fccec5f798'
...
PINS = {
    'colab_neumann_directional_masks_promoted_cold.py': ('4ea6a13bca3e7466f80da72757542cdfd31ade79', '4a813825c2e3cf7facdc25325a86acee93762337eb35c149cde1eafb61079675'),
    'verify_neumann_directional_masks_promoted_cold.py': ('4ea6a13bca3e7466f80da72757542cdfd31ade79', '1076bcbe55e57d6d6bd09ae18041f13ad1b783e89d254f3fafb16cd86d11a3e1'),
...
def verify_scope(files):
    contract = json.loads(files['neumann-directional-masks-promoted-cold-contract.json'])
...
def main():
    ...
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_directional_masks_promoted_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_directional_masks_promoted_cold.py'], 'verify_neumann_directional_masks_promoted_cold.py')
    ...
    print('NEUMANN_DIRECTIONAL_MASKS_COLD_PRESERVED COMPILER_SEAL=1')
