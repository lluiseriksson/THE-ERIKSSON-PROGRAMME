#!/usr/bin/env python3
"""Retained-checkout diagnostic for CMP89 Neumann kernel absorption."""
...
RUNNER_REV = "cmp89-neumann-kernel-absorption-hot-v1"
...
def main() -> int:
    ...
    run("cmp89_neumann_kernel_absorption_focal", [
        "lake", "build", "YangMills.RG.BalabanCMP89SourceNeumannKernelAbsorption",
    ])
    audit = run("cmp89_neumann_kernel_absorption_audit", [
        "lake", "env", "lean",
        "YangMills/RG/BalabanCMP89SourceNeumannKernelAbsorptionAudit.lean",
    ])
    audit_axioms(audit)
