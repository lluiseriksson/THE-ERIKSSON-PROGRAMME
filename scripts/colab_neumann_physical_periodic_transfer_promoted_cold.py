#!/usr/bin/env python3
"""Fresh cold gate for physical periodic transfer and two declarations.
...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-physical-periodic-transfer-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("periodic_focal", ["lake","build","YangMills.RG.NeumannPhysicalPeriodicTransfer"], None),
        ("periodic_audit", ["lake","env","lean","YangMills/RG/NeumannPhysicalPeriodicTransferAudit.lean"], audit_names["periodic_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-physical-periodic-transfer-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
            ...
            'scope': 'literal common-block physical endpoint transfer and integer-period image transfer; not periodic-series convergence, mixed coverage, regional inverse, B0 or window15',
        }, sort_keys=True) + '\n', encoding='utf-8')
        outputs = {}
