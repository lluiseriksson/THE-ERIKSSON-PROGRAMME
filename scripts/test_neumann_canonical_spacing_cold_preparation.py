...
import verify_neumann_canonical_spacing_promoted_cold as v
...
tree = ast.parse(Path('scripts/colab_neumann_canonical_spacing_promoted_cold.py').read_text())
...
audit = blob('YangMills/RG/NeumannCanonicalSpacingNormalizationAudit.lean').decode()
...
v.verify = original
files = captured[0]
key = 'neumann-canonical-spacing-promoted-cold-contract.json'
...
print('CANONICAL_SPACING_COLD_PREPARATION=PASS ACTUAL_CONTRACT=1 SOURCE_BLOBS=2 AUDIT_NAMES=3')
