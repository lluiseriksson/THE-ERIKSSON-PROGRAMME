...
from verify_neumann_integer_block_image_average_hot_v2 import verify, REV
from verify_neumann_counting_reflection_diagnostic_v2 import unpack, sha

archive = Path('validation-evidence/neumann-integer-block-image-average-hot-v2-20260906/'
               'neumann-integer-block-image-average-hot-v2-evidence.tar.gz').read_bytes()
assert sha(archive) == '01a82bb260205e8ca032db0dc60d165c2dfeb75f9073af72fdc29741dbf6e5b7'
...
for key, value in [('source', '0'*40), ('base_source', '0'*40),
                   ...
                   ('support_source', '0'*40), ('parent_outer_sha256', '0'*64)]:
...
reject('source_changed', lambda f, d: f.__setitem__('NeumannIntegerBlockImageAverageDraft.lean', b'changed'))
...
reject('truncated_repro', lambda f, d: f.__setitem__('mathlib-repro.lean', b'import Mathlib\n'))
