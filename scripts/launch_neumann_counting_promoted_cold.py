"""One-shot launcher for the five-name counting reflection/dictionary intermediate cold gate.
...
WORK = Path('/content/neumann-counting-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-counting-promoted-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_counting_promoted_cold.py': (
        '2ef47fc11740a21c4c495fc8d80e0216fdce3887',
        '87aafa61ce1824a5b8fc4acf4cd107944b52e9531d2fb37bebaa3dde99d9033f'),
    'verify_neumann_counting_promoted_cold.py': (
        '2ef47fc11740a21c4c495fc8d80e0216fdce3887',
        '9decd5ede386cf72c30c6a1909e545f852a68e8fad4801ba48674adbe0caf5c5'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_counting_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_counting_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_counting_promoted_cold.py')
