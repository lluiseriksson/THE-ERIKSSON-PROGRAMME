...
def main():
    outputs = [artifact(f"scripts/surface_remainder_{unit}{suffix}.txt")
    ...
    inputs = [artifact(relative) for relative in (
        ...
        "scripts/audit_surface_remainder_k4_positive_0305_0500.py",
    ...
    data = {
        ...
        "commands": {
            ...
            "unit_validator": "python scripts/validate_surface_remainder_k4_positive_0305_0500.py --unit <unit>",
            "union_audit": "python scripts/audit_surface_remainder_k4_positive_0305_0500.py",
        },
