...
ITEMS = [('f8e37328b37b8e37b4178ed295cc5d6f7917d06e', 'NeumannIntegerBlockImageAverage', 3)]
...
manifest = 'tmp/neumann_integer_block_image_average_promotion_paths.txt'
...
print('BLOCK_AVERAGE_PROMOTION_STATIC=PASS COMPILER_CHECKED=0')
