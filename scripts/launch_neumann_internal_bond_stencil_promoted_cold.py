"""One-shot launcher for the four-name Neumann internal-bond stencil intermediate cold gate.
...
WORK = Path('/content/neumann-internal-bond-stencil-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-internal-bond-stencil-promoted-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_internal_bond_stencil_promoted_cold.py': (
        '2b641e2ba98a78e2390252791c0a503778d33e67',
        '15b6ec93051d138a1d2ee3197bb1cd4143ee18cdd3c542c901486800655ee43a'),
    'verify_neumann_internal_bond_stencil_promoted_cold.py': (
        '2b641e2ba98a78e2390252791c0a503778d33e67',
        '0c05cae2596a96c7fac5ff334da996b53ef153a06bdae4eaa68d368ffce55729'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_internal_bond_stencil_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_internal_bond_stencil_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_internal_bond_stencil_promoted_cold.py')
