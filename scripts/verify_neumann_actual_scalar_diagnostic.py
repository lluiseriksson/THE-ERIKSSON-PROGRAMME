...
REV = 'neumann-actual-scalar-diagnostic-v1'
ROOT = '/content/hrpoly-' + REV
RUNNER_HASH = 'eb687845d46b4d9792cb0c2b2e2d301c11a566978616e69fb24db17bd9ff157a'
...
COMMANDS = {
    ...
    'scalar_prerequisites': ['lake','build','YangMills.RG.BalabanCMP89Eq246StabilizedAliasFullSolution'],
...
SCOPE = 'actual non-transpose full-solution scalar homogeneity only; not endpoint covariance, inverse, B0 or window15'
...
def verify(files):
    ...
    c=json.loads(files['scalar-contract.json'])
    ...
    expected_files={'runner.py','durable-base.py','axiom-gate.py','evidence.json','scalar-contract.json','gate-contract.json','preflight.json'}
    idx={}
    for r in records:
        s=r['stage'];idx[s]=r
    ...
    outputs=c['outputs']
    require(set(outputs)=={'NeumannActualFullSolutionScalarDraft.olean'},'OUTPUT_SET')
