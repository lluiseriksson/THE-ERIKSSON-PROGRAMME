#!/usr/bin/env python3
"""Hot diagnostic for the physical two-scale Neumann Poincare adapter."""
...
RUNNER_REV = "cmp89-neumann-two-scale-poincare-adapter-hot-v1"
SOURCE_SHA = "a220888f02f0458b7c380c7ee920224daeeae86c"
...
EXPECTED_BLOBS = {
    "YangMills/RG/BalabanCMP89SourceNeumannTwoScalePoincareAdapter.lean":
        "1ce1b3450f4730eb30acd1b236cb8df32b7ac3b8",
    "YangMills/RG/BalabanCMP89SourceNeumannTwoScalePoincareAdapterAudit.lean":
        "d166c3e1ecb2477523cb10487c095a43d14b35ca",
}
...
def main() -> int:
    ...
    manifest = Path("/content/cmp89-neumann-two-scale-poincare-adapter-hot-paths.txt")
    manifest.write_text("\n".join(EXPECTED_BLOBS) + "\n", encoding="utf-8")
    ...
    run("focal", [
        "lake", "build",
        "YangMills.RG.BalabanCMP89SourceNeumannTwoScalePoincareAdapter",
    ])
    audit = run("audit", [
        "lake", "env", "lean",
        "YangMills/RG/BalabanCMP89SourceNeumannTwoScalePoincareAdapterAudit.lean",
    ...
    if len(blocks) != 1 or names != EXPECTED_DECLARATIONS:
