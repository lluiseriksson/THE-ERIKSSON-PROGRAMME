#!/usr/bin/env python3
"""Cold Colab validation for the transposed full solution of CMP89 Eq. (2.46)."""
...
spec = importlib.util.spec_from_file_location(
    "cmp89_eq246_transpose_full_solution_base", BASE_RUNNER
)
...
EXPECTED_BY_COUNT = {
    6: {
        "YangMills.RG.cmp89Eq246CentralAverageColumn_ne_zero_of_pair_ne_zero",
        "YangMills.RG.cmp89Eq246StabilizedAliasTransposeNoncentralSourceMoment",
        "YangMills.RG.cmp89Eq246StabilizedAliasTransposeFullSolutionMoment",
        "YangMills.RG.cmp89Eq246StabilizedAliasTransposeFullSolution",
        "YangMills.RG.sum_column_mul_cmp89Eq246StabilizedAliasTransposeFullSolution_eq",
        "YangMills.RG.cmp89Eq246EntireAliasPrecisionMatrix_transpose_mulVec_stabilizedFullSolution",
    },
}
...
runner.RUNNER_REV = "cmp89-eq246-transpose-full-solution-cold-v1"
runner.SOURCE_SHA = "a6b1e7eec7bb555ae4f34724732a4e3d39c77d14"
runner.ROOT = Path("/content/hrpoly-cmp89-eq246-transpose-full-solution-cold-v1")
runner.EVIDENCE = Path(
    "/content/hrpoly-cmp89-eq246-transpose-full-solution-cold-v1-evidence"
)
runner.ARCHIVE = Path(
    "/content/hrpoly-cmp89-eq246-transpose-full-solution-cold-v1-evidence.tar.gz"
)
runner.PATH_MANIFEST = Path(
    "/content/hrpoly-cmp89-eq246-transpose-full-solution-cold-v1-paths.txt"
)
runner.SOURCE_BLOBS = {
...
runner.QUEUE = [
    (
        ...
        [
            "lake",
            "build",
            "YangMills.RG.BalabanCMP89Eq246StabilizedAliasTransposeFullSolution",
        ],
        None,
    ),
    (
