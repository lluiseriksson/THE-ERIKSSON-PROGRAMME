"""Reproducible K4 endpoint strip at the independent stress t=2.95.

This is a scoped witness only.  It deliberately does not alter the frozen
endpoint-strip transcript at t=2.9 or carry any global K4/S1'''/S2''' claim.
"""
...
DEPENDENCIES = (
    "scripts/surface_remainder_k4_endpoint_strip_t295.py",
...
def run():
    ...
    lines = [
        "K4 ENDPOINT TWO-BOX STRIP T295",
    ...
    lines.append("K4 ENDPOINT TWO-BOX STRIP T295 PASS" if passed
                 else "K4 ENDPOINT TWO-BOX STRIP T295 FAIL")
    lines.append("SCOPE t=2.95 only; delta [0.048,0.05]; no global K4 theorem claim")
    return "\n".join(lines) + "\n"
