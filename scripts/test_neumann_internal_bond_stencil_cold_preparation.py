...
import verify_neumann_internal_bond_stencil_promoted_cold as v
...
tree = ast.parse(Path('scripts/colab_neumann_internal_bond_stencil_promoted_cold.py').read_text())
...
audit = blob('YangMills/RG/NeumannInternalBondStencilAudit.lean').decode()
...
v.verify = original
files = captured[0]
key = 'neumann-internal-bond-stencil-promoted-cold-contract.json'
...
print('INTERNAL_BOND_STENCIL_COLD_PREPARATION=PASS ACTUAL_CONTRACT=1 SOURCE_BLOBS=2 AUDIT_NAMES=4')
