"""Production/replay runner for the preregistered K4 lower band."""
...
DRIVER = ROOT / "scripts" / "certify_surface_remainder_k4_centered_00290_00295.py"
UNIT = "k4_00290_00295"
...
def main() -> None:
    ...
    result = subprocess.run(
        [sys.executable, str(DRIVER)], cwd=ROOT,
