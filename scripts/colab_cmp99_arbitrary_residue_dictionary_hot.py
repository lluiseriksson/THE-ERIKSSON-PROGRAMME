...
RUNNER_REV = "cmp99-arbitrary-residue-dictionary-hot-v1"
SOURCE_SHA = "952d536ba2e36349ed19a870e0eb7aa01687c113"
...
def main() -> int:
    ...
    manifest = Path("/content/cmp99-arbitrary-residue-dictionary-hot-v1-paths.txt")
    manifest.write_text("\n".join(SOURCE_BLOBS) + "\n", encoding="utf-8")
    run(
        "overlay_text_guard",
