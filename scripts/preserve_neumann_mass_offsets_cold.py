"""Verify and preserve exact mass-offset cold PASS; rejects partial/failing evidence."""
import argparse
import json
import math
...
LAUNCHER = 'launch_neumann_mass_offsets_promoted_cold.py'
LAUNCHER_HASH = 'e294bd0fe7fd545607aceefd7ded411959d2b20a6fe9de28986c738dd5a72173'
...
PINS = {
    'colab_neumann_mass_offsets_promoted_cold.py': ('48d3b3df4f214a6335f1b7c438fcb945731661fb', '5c46e6caf65796bfba486cebc498c42c8d701978df398bc4798a58b33168f625'),
    'verify_neumann_mass_offsets_promoted_cold.py': ('48d3b3df4f214a6335f1b7c438fcb945731661fb', 'bb097d627a5405373c2ebf93d43c6706bf1bad8f585af8ce781b11aeef4343c1'),
...
def verify_scope(files):
    contract = json.loads(files['neumann-mass-offsets-promoted-cold-contract.json'])
...
def main():
    ...
    verifier = work + 'verify_neumann_mass_offsets_promoted_cold.py'
    commands = [[py, verifier, '--helpers', work.rstrip('/'), '--self-test'],
        [py, work + 'colab_neumann_mass_offsets_promoted_cold.py'],
    ...
    cold = load(outer[prefix + 'verify_neumann_mass_offsets_promoted_cold.py'], 'verify_neumann_mass_offsets_promoted_cold.py')
    ...
    print('NEUMANN_MASS_OFFSETS_COLD_PRESERVED COMPILER_SEAL=1')
