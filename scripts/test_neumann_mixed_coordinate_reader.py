...
import verify_neumann_mixed_coordinate_hot as v
...
runner='4ed450dd388a04d3347b6df5c940fac931645502:scripts/colab_neumann_mixed_coordinate_hot.py'
...
for s,c in cmds.items():
 ...
 if s=='parent_verify':text='{}\nNEUMANN_PERIODIC_INTERVAL_COLD_EVIDENCE_VERIFIED\n'
 if s in v.NAMES:
...
print('MIXED_COORDINATE_READER_SELF_TEST_PASS synthetic=1 rejected='+str(rejected))
