"""Authoritative segmented regular-K2 cover on delta in [0,1/200]."""
...
DEPENDENCIES = (
    "scripts/certify_surface_remainder_delta0_r4_extension.py",
    "scripts/surface_remainder_delta0_r4_extension_probe.py",
    "scripts/surface_remainder_delta0_r4_extension_cover.py",
...
GRID_RANGES = ((0, 150, 96), (151, 157, 192))
...
def main():
    ...
    for index in range(args.start_index, args.stop_index):
        ...
        if worst is None or lower < worst[0]:
            worst = (lower, index)
    print("CERTIFIED SEGMENT regular K2 r4 delta [0,1/200] start",
