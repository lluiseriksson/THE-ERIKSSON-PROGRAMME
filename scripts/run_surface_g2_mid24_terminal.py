"""Fresh terminal-contract runner for the order-24 beta gap."""
...
PREREG = "docs/SURFACE-G2-MID24-TERMINAL-PREREG-20260725.md"
...
def transcript(index, lo, hi, rows, cache_entries):
    ...
    wrapper = "scripts/run_surface_g2_mid24_terminal.py"
    text = text.replace(
