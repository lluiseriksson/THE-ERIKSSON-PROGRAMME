#!/usr/bin/env python3
"""Fresh cold gate for branch packaging and seven declarations.
...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-mixed-branch-packaging-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("branch_focal", ["lake","build","YangMills.RG.NeumannMixedBranchPackaging"], None),
        ("branch_audit", ["lake","env","lean","YangMills/RG/NeumannMixedBranchPackagingAudit.lean"], audit_names["branch_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-mixed-branch-packaging-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
            ...
            'scope': 'exact global fixed-source index packaging and at-most16 branches in 4D; not physical carrier classification, physical inverse, uniform B0 or window15',
        }, sort_keys=True) + '\n', encoding='utf-8')
        outputs = {}
