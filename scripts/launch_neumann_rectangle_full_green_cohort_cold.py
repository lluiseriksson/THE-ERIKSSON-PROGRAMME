"""One-shot launcher for the eight-name rectangle/full-G intermediate cold gate.
...
WORK = Path('/content/neumann-rectangle-full-green-cohort-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-rectangle-full-green-cohort-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_rectangle_full_green_cohort_cold.py': (
        'fef8e4bbbed0968c042fc7bce878d086c17c81b4',
        '88bbb14199688b5794aa403025959edfd1442a9070401a44b10080bb228c17a6'),
    'verify_neumann_rectangle_full_green_cohort_cold.py': (
        'fef8e4bbbed0968c042fc7bce878d086c17c81b4',
        '4643059f68bc5229f04596c55440aab66490747971ea718a1ac39f0f494df773'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_rectangle_full_green_cohort_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_rectangle_full_green_cohort_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_rectangle_full_green_cohort_cold.py')
