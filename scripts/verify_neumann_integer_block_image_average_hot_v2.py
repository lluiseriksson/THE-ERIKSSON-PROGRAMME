...
SOURCE = 'f8e37328b37b8e37b4178ed295cc5d6f7917d06e'
BASE = 'af35fbb8c75bf2347543034b3abf27f0217b1bbf'
REV = 'neumann-integer-block-image-average-hot-v2'
ROOT = '/content/hrpoly-neumann-integer-dictionary-cohort-cold-v1'
RUNNER_HASH = 'fe187a4059ecf6af61b611b700a8b06aaa092763db1b8e665fe8470c776ff09a'
...
def verify(files):
    ...
    require(data['support_source'] == runner.SUPPORT_SOURCE == '4c8171bdc4f70606d89de05f53b6f90d39e689b8', 'SUPPORT_SOURCE')
    ...
    exec(compile(files['neumann_integer_block_image_average_repro_contract.py'], 'pinned_contract', 'exec'), contract.__dict__)
    ...
    require(sha(repro) == 'a71771253badcf3e43f42bcb567c63f84726975c6c64610fb026363a0ba3a555', 'REPRO_HASH')
    ...
    commands['physical_prerequisites'] = ['lake', 'build', 'YangMills.RG.NeumannHalfCellBlockReflection', 'YangMills.RG.NeumannIntegerImageCountingKernel']
    ...
    for s, path in [('mathlib_repro', 'tmp/mathlib-repro.lean'),
                    ('physical_draft', 'tmp/NeumannIntegerBlockImageAverageDraft.lean')]:
