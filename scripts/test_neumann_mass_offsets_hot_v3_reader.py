...
final = True
rt = Path('scripts/colab_neumann_generated_mass_complete_offsets_hot_v3.py' if final else
          'tmp/colab_neumann_generated_mass_complete_offsets_hot_v3.py.template').read_text()
vt = Path('scripts/verify_neumann_generated_mass_complete_offsets_hot_v3.py' if final else
          'tmp/verify_neumann_generated_mass_complete_offsets_hot_v3.py.template').read_text()
if not final:
