...
PINS = {
    ...
    'tmp/NeumannFiniteIntegerCoordinatesMathlibRepro.lean': '81ab7afdab251a126c2c11814cb551957b63e46e210bd3bc7dda0d4691297bbe',
...
def main():
    ...
    try:
        ...
        for stage, path in [('mathlib_repro', 'tmp/NeumannFiniteIntegerCoordinatesMathlibRepro.lean'),
            ...
            op = OUT / (stage + '.olean')
            text = run(stage, ['lake', 'env', 'lean', '-o', str(op), path])
