...
OUT=Path('/content/neumann-mixed-fixed-source-hot-v2')
PINS={
 'tmp/NeumannFixedSourceProjectionRepro.lean':'c2a4bcd2831a9084b75e916c2a587f9019af48128f457f24b43cdaba71ee7c66',
 'tmp/NeumannMixedFixedSourceDraft.lean':'6bf22d2c3a5e1a8d206c024eb2e9ec70d9600136287e94fe126d3909f7daf3fd',
...
def main():
 ...
 try:
  ...
  audits={}
  audits['repro']=exact_axioms(run('repro',['lake','env','lean',str(OUT/'NeumannFixedSourceProjectionRepro.lean')],60),{'neumannFixedSourceProjectionRepro'})
