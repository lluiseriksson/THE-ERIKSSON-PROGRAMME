#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for the directed physical fine kernel."""
...
spec = importlib.util.spec_from_file_location("cmp89_directed_physical_fine_base", BASE_RUNNER)
...
EXPECTED = {
    308: {
        "YangMills.RG.cmp89Eq246DirectedNormalizedPhysicalFineKernel",
        "YangMills.RG.cmp89Eq246PhysicalFineEndpointDifference_eq",
        "YangMills.RG.norm_cmp89Eq246DirectedNormalizedPhysicalFineKernel_le",
        "YangMills.RG.cmp89Eq246DirectedNormalizedPhysicalFineKernel_zero_eq_realGreenSynthesis",
    },
}
...
runner.QUEUE = [
    (
        ...
        ["lake", "build", "YangMills.RG.BalabanCMP89Eq246DirectedNormalizedPhysicalFineKernel"],
        None,
    ),
    (
        "directed_normalized_physical_fine_kernel_audit",
        ["lake", "env", "lean", "YangMills/RG/BalabanCMP89Eq246DirectedNormalizedPhysicalFineKernelAudit.lean"],
        308,
    ),
]
