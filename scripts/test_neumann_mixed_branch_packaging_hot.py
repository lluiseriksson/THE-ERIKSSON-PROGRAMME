...
import verify_neumann_mixed_branch_packaging_hot as v
...
runner='965c01410829fc0bda0790c14798cdb2d6762e2d:scripts/colab_neumann_mixed_branch_packaging_hot.py'
...
print('MIXED_BRANCH_PACKAGING_READER_SELF_TEST_PASS synthetic=1 rejected='+str(rejected))
