...
PINS = {
    "tmp/NeumannIntegerBlockImageAverageDraft.lean": "ee36a38d52eb90179b2848e1a29bb89759c164fca68a6a56c875e2dd07dd54f9",
...
def main():
    ...
    try:
        ...
        assert sha(repro) == 'a71771253badcf3e43f42bcb567c63f84726975c6c64610fb026363a0ba3a555', 'REPRO_HASH'
        ...
        (OUT / 'result.json').write_text(json.dumps(dict(status=status, source=SOURCE,
            ...
            scope='finite block-image averaging transport, not physical Q or image inverse'), sort_keys=True) + '\n')
