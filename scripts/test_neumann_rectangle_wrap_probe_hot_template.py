...
assert ast.literal_eval(draft_loops[0].iter) == [('physical_draft', 'NeumannRectangleWrapProbeDraft.lean')], 'ACTUAL_DRAFT_LOOP'
...
env = dict(Path=PurePosixPath, str=str,
    ...
    path='NeumannRectangleWrapProbeDraft.lean')
