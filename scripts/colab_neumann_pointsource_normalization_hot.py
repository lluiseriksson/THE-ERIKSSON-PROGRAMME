#!/usr/bin/env python3
"""Bounded point-source normalization diagnostics; no physical source equation seal."""
...
BASE = 'a5811d5ddd78faf6fe638aa00db30276af826baf'
ROOT = Path('/content/hrpoly-neumann-physical-mixed-seam-promoted-cold-v1')
OUT = Path('/content/neumann-pointsource-normalization-hot-v1')
...
def main():
    ...
    if not Path('/content/physical-seam-cold-evidence-preserved.ok').is_file():
