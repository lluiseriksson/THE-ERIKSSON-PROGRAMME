...
OUT = ROOT / "run-records" / "local-staging" / "surface-scaled-bulk-cwin3p2-post1635-terminal-20260725.json"
...
def main() -> int:
    specs = (
        ...
        ("post1635_4_half", "surface_scaled_bulk_post1635_terminal_4_half.txt",
         "surface_scaled_bulk_post1635_terminal_4_half_rerun.txt"),
        ("post1635_5_half", "surface_scaled_bulk_post1635_terminal_5_half.txt",
         "surface_scaled_bulk_post1635_terminal_5_half_rerun.txt"),
        ("post1635_6_half", "surface_scaled_bulk_post1635_terminal_6_half.txt",
        ...
        ("post1635_9_half", "surface_scaled_bulk_post1635_terminal_9_half.txt",
         "surface_scaled_bulk_post1635_terminal_9_half_rerun.txt"),
        ("post1635_10_half", "surface_scaled_bulk_post1635_terminal_10_half.txt",
         "surface_scaled_bulk_post1635_terminal_10_half_rerun.txt"),
    )
    units = []
    ...
    manifest = {
        ...
        "claim_scope": "CWIN=3/2 terminal direct-sign cover for beta [1635/16,3409/32]; post1635 extension only; no H_tail/G2/G6 promotion.",
