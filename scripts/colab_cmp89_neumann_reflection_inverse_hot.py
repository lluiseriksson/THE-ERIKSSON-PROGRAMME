#!/usr/bin/env python3
"""Retained-runtime diagnostic for the CMP89 reflection inverse producer.

This is not cold-seal authority. It checks the internally assembled scalar
reflection operator and the inverse-uniqueness producer at one exact source
checkpoint, stopping at the first error.
"""
...
RUNNER_REV = "cmp89-neumann-reflection-inverse-hot-v1"
SOURCE_SHA = "aadae4772290ddfd3aceddeefab3282122669526"
ROOT = Path("/content/hrpoly-cmp89-neumann-rectangle-lift-cold")
SOURCE_BLOBS = {
    "YangMills/RG/BalabanCMP89NeumannScalarReflectionOperator.lean":
        "17877de0a77ac75be3dab303b7753b660e5f10995e54e02a5719c179139876e9",
...
def main() -> int:
    ...
    paths = Path("/content/cmp89-neumann-reflection-inverse-hot-paths.txt")
    paths.write_text("\n".join(SOURCE_BLOBS) + "\n", encoding="utf-8")
