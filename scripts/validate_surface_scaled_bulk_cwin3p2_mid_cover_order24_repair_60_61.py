"""Validate production/replay for the order-24 extension-2 units."""
...
BASES = [
    ROOT / "scripts" / "surface_scaled_bulk_mid_cover_60_253_4_127_2",
    ROOT / "scripts" / "surface_scaled_bulk_mid_cover_61_127_2_255_4",
]
...
def main() -> int:
    ...
    print("ORDER24 EXTENSION2 VALIDATION PASS", "UNITS", len(BASES), "ROWS", total)
