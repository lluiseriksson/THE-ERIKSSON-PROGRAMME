"""Fresh bounded diagnostic of the actual non-transpose full solution.
...
def main():
    ...
    r.QUEUE = [
        ...
        ('scalar_prerequisites', ['lake', 'build', 'YangMills.RG.BalabanCMP89Eq246StabilizedAliasFullSolution'], None),
        ...
        ('clean_after', ['git', 'diff', '--exit-code', 'HEAD', '--', 'YangMills', 'tmp/NeumannActualFullSolutionScalarDraft.lean', 'lean-toolchain', 'lake-manifest.json'], None),
    ]
    ...
    def preserve(status, opened):
        ...
        outputs = {}
        for name in ('NeumannActualFullSolutionScalarDraft',):
        ...
        (r.EVIDENCE / 'scalar-contract.json').write_text(json.dumps(dict(
