...
RUNNER_HASH = '16bbb9de0ee2c3676ab421967419d238524c40fb8c30b84db865e51a5700c531'
...
def verify(files):
    ...
    require(data['scope'] == "finite retained torus wrap-bond witness only; not a norm bound, nonperiodic boundary inverse, uniform B0 or window15", 'PHYSICAL_SCOPE')
    ...
    for s, name in [('physical_draft', 'NeumannRectangleWrapProbeDraft.lean')]:
    ...
    for s, path in [('physical_draft', 'tmp/NeumannRectangleWrapProbeDraft.lean')]:
