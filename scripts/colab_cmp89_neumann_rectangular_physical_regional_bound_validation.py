#!/usr/bin/env python3
"""Cold Colab gate for the CMP89 physical regional Green value bound.
...
pins, and validates the regional consumer plus its exact axiom audit.  Passing
does not construct the CMP89 (2.42) representation certificate, move 20/41,
...
RUNNER_REV = "cmp89-neumann-physical-regional-bound-v1"
...
ROOT = CONTENT / "hrpoly-cmp89-regional-bound-cold-466b9de3"
EVIDENCE = CONTENT / "hrpoly-cmp89-regional-bound-cold-466b9de3-evidence"
ARCHIVE = CONTENT / "hrpoly-cmp89-regional-bound-cold-466b9de3-evidence.tar.gz"
...
PATH_MANIFEST = CONTENT / "hrpoly-cmp89-regional-bound-paths.txt"
...
def main() -> int:
    ...
    try:
        ...
        run(
            ...
            [
                "lake", "build",
                "YangMills.RG.BalabanCMP89NeumannRectangularPhysicalRegionalBound",
            ],
            cwd=ROOT,
        )
        audit = run(
