"""One-shot launcher for the three-name canonical Neumann precision intermediate cold gate.
...
WORK = Path('/content/neumann-canonical-spacing-promoted-cold-v1-launch')
INNER = Path('/content/hrpoly-' + REV + '-evidence.tar.gz')
OUTER = Path('/content/neumann-canonical-spacing-promoted-cold-v1-preservation-20260906.tar.gz')
RAW = 'https://raw.githubusercontent.com/lluiseriksson/THE-ERIKSSON-PROGRAMME/'
FILES = {
    'colab_neumann_canonical_spacing_promoted_cold.py': (
        'e2693781db75058bd69d74fa659b17da2f89d6f0',
        'dc92529f0d7f10a076c939f32462872cd3a362abc0c057b299e1386a35b06c9f'),
    'verify_neumann_canonical_spacing_promoted_cold.py': (
        'e2693781db75058bd69d74fa659b17da2f89d6f0',
        '50ed7d38dc3695a48eb1e709f0b10f5ac14a9ec3c60f526f1c89c7ae4805ca94'),
...
def main():
    ...
    try:
        ...
        verifier=str(WORK/'verify_neumann_canonical_spacing_promoted_cold.py')
        child('verifier_self_test',[sys.executable,verifier,'--helpers',str(WORK),'--self-test'])
        child('physical_cold_graph',[sys.executable,str(WORK/'colab_neumann_canonical_spacing_promoted_cold.py')])
        ...
        with tarfile.open(OUTER,'w:gz') as tar:
            ...
            tar.add(Path(__file__),arcname='launch_neumann_canonical_spacing_promoted_cold.py')
