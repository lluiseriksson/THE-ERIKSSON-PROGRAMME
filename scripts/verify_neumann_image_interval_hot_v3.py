...
RUNNER_HASH = '905da643d92010978234b6ed41ebfe0ac5db5496c0e8e1701df24df0f2fd4761'
...
def verify(files):
    ...
    require(sha(repro) == 'fcba09ae86be8170f949e593990d1062dbe4ab8e7980b63576ef7ba49dc7327a', 'REPRO_HASH')
