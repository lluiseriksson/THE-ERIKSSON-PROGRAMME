...
RUNNER_HASH = '97c33c88e4f00d4af9752394c3f79231d0a988a3791b8ed845e9ee3f99f0bceb'
...
COMMANDS = {
    ...
    'scalar_prerequisites': ['lake', 'build', 'YangMills.RG.BalabanCMP89Eq246FinePointSourceHolomorphy', 'YangMills.RG.BalabanCMP89CenteredTorusGreenCoefficientPhase'],
    'scalar_physical': ['lake', 'env', 'lean', '-o', LIB+'NeumannActualFullSolutionScalarDraft.olean', 'tmp/NeumannActualFullSolutionScalarDraft.lean'],
    'phase_physical': ['lake', 'env', 'lean', '-o', LIB+'NeumannCommonBlockEndpointPhaseDraft.olean', 'tmp/NeumannCommonBlockEndpointPhaseDraft.lean'],
    'translation_physical': ['lake', 'env', 'lean', '-o', LIB+'NeumannActualCommonBlockTranslationDraft.olean', 'tmp/NeumannActualCommonBlockTranslationDraft.lean'],
...
def verify(files):
    ...
    c=json.loads(files['translation-contract.json'])
    ...
    expected_files={'runner.py','durable-base.py','axiom-gate.py','evidence.json','translation-contract.json','gate-contract.json','preflight.json'}
    idx={}
    for r in records:
        s=r['stage'];idx[s]=r
    ...
    outputs=c['outputs']
    require(set(outputs)=={'NeumannActualFullSolutionScalarDraft.olean', 'NeumannCommonBlockEndpointPhaseDraft.olean', 'NeumannActualCommonBlockTranslationDraft.olean'},'OUTPUT_SET')
