#!/usr/bin/env python3
"""Fresh cold gate for mixed coordinate coverage and five declarations.
...
def main():
    ...
    runner = base.runner
    runner.RUNNER_REV = 'neumann-mixed-coordinate-promoted-cold-v1'
    ...
    runner.QUEUE = [
        ("mixed_focal", ["lake","build","YangMills.RG.NeumannMixedCoordinateCoverage"], None),
        ("mixed_audit", ["lake","env","lean","YangMills/RG/NeumannMixedCoordinateCoverageAudit.lean"], audit_names["mixed_audit"]),
    ]
    ...
    def make_evidence(status, opened):
        ...
        (runner.EVIDENCE / 'neumann-mixed-coordinate-promoted-cold-contract.json').write_text(json.dumps({
            'source_sha': SOURCE,
            ...
            'scope': 'mixed coordinate image bijection with single FULL branch and PROPER reflection pair; not physical carrier classification, physical inverse, uniform B0 or window15',
        }, sort_keys=True) + '\n', encoding='utf-8')
        outputs = {}
