...
def validate():
    ...
    for path in TRANSCRIPTS:
        ...
        if ("delta_max 1/125" not in config
                or "physical_inner 1181/1000" not in config
                or "band_radius 66/5" not in config):
    ...
    print("K2 delta 0.008 transcripts OK: 158 boxes, band radius 66/5, "
