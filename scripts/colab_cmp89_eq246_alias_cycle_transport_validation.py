#!/usr/bin/env python3
"""Fresh-checkout Colab cold gate for CMP89 alias-cycle factor transport."""
...
spec = importlib.util.spec_from_file_location("cmp89_alias_cycle_transport_base", BASE_RUNNER)
...
runner.RUNNER_REV = "cmp89-eq246-alias-cycle-transport-cold-v1"
runner.SOURCE_SHA = "e8383c00d2cba1c9a704be1d1293e0f5c2ea13ec"
runner.MIN_RAM_GIB = 11.0
runner.ALLOW_GPU_RUNTIME = False
runner.ROOT = Path("/content/hrpoly-cmp89-eq246-alias-cycle-transport-cold-v1")
runner.EVIDENCE = Path("/content/hrpoly-cmp89-eq246-alias-cycle-transport-cold-v1-evidence")
runner.ARCHIVE = Path("/content/hrpoly-cmp89-eq246-alias-cycle-transport-cold-v1-evidence.tar.gz")
runner.PATH_MANIFEST = Path("/content/hrpoly-cmp89-eq246-alias-cycle-transport-cold-v1-paths.txt")
runner.SOURCE_BLOBS = {
