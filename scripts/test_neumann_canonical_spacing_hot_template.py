...
rt = Path('tmp/colab_neumann_canonical_spacing_hot_template.py').read_text()
vt = Path('tmp/verify_neumann_canonical_spacing_hot_template.py').read_text()
...
parent = dict(status='VERIFIED_COLD_PASS', source=r0.BASE, cold_seal=True,
    ...
    production_outputs={'NeumannCanonicalPrecisionOffsetAction.olean': '3'*64}))
...
print('CANONICAL_SPACING_TEMPLATE_SYNTHETIC_SELF_TEST=PASS valid=1 rejected=10 preserved_failure=1')
